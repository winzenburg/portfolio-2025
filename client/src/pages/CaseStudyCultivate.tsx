      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <div className="inline-block px-4 py-2 bg-emerald-500/20 border border-emerald-500/30 rounded-full mb-6">
            <span className="text-emerald-700 text-sm font-medium">Hero Project · 2025</span>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <section className="mb-16">
          ...
          <div className="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-lg p-6 mb-8">
            <h3 className="text-xl font-bold mb-3 text-emerald-700">What is Cultivate?</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-muted border border-border rounded-lg p-6">
              <h4 className="text-lg font-bold mb-3 text-emerald-700">Portfolio Approach</h4>
            ...
            <div className="bg-muted border border-border rounded-lg p-6">
              <h4 className="text-lg font-bold mb-3 text-emerald-700">25-Agent System</h4>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-muted border border-border rounded-lg p-6">
              <h4 className="text-lg font-bold mb-3 text-emerald-700">8 Quality Gates</h4>
              <p className="text-muted-foreground text-sm">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            {/* Four Phases */}
            <div className="bg-muted border border-emerald-500/30 rounded-lg p-6">
              <h3 className="text-xl font-bold mb-4 text-emerald-700">Four Phases, Eight Gates</h3>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-emerald-700 bg-emerald-500/10 p-3 rounded">
            ...
            {/* The Agent Orchestra */}
            <div className="bg-muted border border-emerald-500/30 rounded-lg p-6">
              <h3 className="text-xl font-bold mb-4 text-emerald-700">The 25-Agent Orchestra</h3>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            <div className="bg-muted border-l-4 border-emerald-500 rounded-r-lg p-6">
              <h3 className="text-lg font-bold mb-2 text-emerald-700">Portfolio Dashboard</h3>
            ...
            <div className="bg-muted border-l-4 border-emerald-500 rounded-r-lg p-6">
              <h3 className="text-lg font-bold mb-2 text-emerald-700">Workflow Tracking</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-muted border-l-4 border-emerald-500 rounded-r-lg p-6">
              <h3 className="text-lg font-bold mb-2 text-emerald-700">Document Discovery</h3>
              <p className="text-muted-foreground">
            ...
            <div className="bg-muted border-l-4 border-emerald-500 rounded-r-lg p-6">
              <h3 className="text-lg font-bold mb-2 text-emerald-700">BOS Home Dashboard</h3>
              <p className="text-muted-foreground">
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6">
            <div className="bg-muted border-l-4 border-emerald-500 rounded-r-lg p-6">
              <h3 className="text-lg font-bold mb-2 text-emerald-700">Dual-Filter Validation Framework</h3>
            ...
            <div className="bg-muted border-l-4 border-emerald-500 rounded-r-lg p-6">
              <h3 className="text-lg font-bold mb-2 text-emerald-700">AI Orchestration System</h3>
              <p className="text-muted-foreground mb-3">
            ...
            <div className="bg-muted border-l-4 border-emerald-500 rounded-r-lg p-6">
              <h3 className="text-lg font-bold mb-2 text-emerald-700">150+ Rules in Four-Tier Taxonomy</h3>
              <p className="text-muted-foreground mb-3">
            ...
            <div className="bg-muted border-l-4 border-emerald-500 rounded-r-lg p-6">
              <h3 className="text-lg font-bold mb-2 text-emerald-700">Portfolio-First Architecture</h3>
              <p className="text-muted-foreground">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-muted border border-border rounded-lg p-6">
              <h3 className="text-lg font-bold mb-4 text-emerald-700">Core Platform</h3>
            ...
            <div className="bg-muted border border-border rounded-lg p-6">
              <h3 className="text-lg font-bold mb-4 text-emerald-700">AI Orchestration</h3>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-700 mt-1">•</span>
            ...
            <div className="bg-muted border border-border rounded-lg p-6">
              <h3 className="text-lg font-bold mb-4 text-emerald-700">Infrastructure</h3>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-700 mt-1">•</span>
            ...
            <div className="bg-muted border border-border rounded-lg p-6">
              <h3 className="text-lg font-bold mb-4 text-emerald-700">Quality & Testing</h3>
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-700 mt-1">•</span>
          ...
          <div className="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-lg p-6">
            ...
            <div className="space-y-3 text-muted-foreground">
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 bg-emerald-500/20 rounded flex items-center justify-center text-emerald-700 text-sm font-bold">✓</div>
                <span><strong className="text-emerald-700">Monorepo Structure:</strong> All projects in single repo with shared libraries and consistent patterns</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 bg-emerald-500/20 rounded flex items-center justify-center text-emerald-700 text-sm font-bold">✓</div>
                <span><strong className="text-emerald-700">Feature Modules:</strong> Domain-driven structure with no cross-feature imports</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 bg-emerald-500/20 rounded flex items-center justify-center text-emerald-700 text-sm font-bold">✓</div>
                <span><strong className="text-emerald-700">Boring Technology:</strong> Proven, maintainable solutions over bleeding-edge hype</span>
              </div>
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-6 h-6 bg-emerald-500/20 rounded flex items-center justify-center text-emerald-700 text-sm font-bold">✓</div>
                <span><strong className="text-emerald-700">Documentation as Code:</strong> 150+ rules, 40+ context documents, systematic knowledge capture</span>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-lg p-6">
              <h3 className="text-lg font-bold mb-3 text-emerald-700">Systems Thinking at Scale</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-lg p-6">
              <h3 className="text-lg font-bold mb-3 text-emerald-700">Process Design Expertise</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-lg p-6">
              <h3 className="text-lg font-bold mb-3 text-emerald-700">AI Orchestration Mastery</h3>
              <p className="text-muted-foreground text-sm">
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/30 rounded-lg p-6">
              <h3 className="text-lg font-bold mb-3 text-emerald-700">Product Strategy & Validation</h3>
              <p className="text-muted-foreground text-sm">
          ...
          <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-6">
            <h3 className="text-lg font-bold mb-3 text-emerald-700">The Meta-Skill: Building Systems That Build Products</h3>
        ...
        <section className="mb-16">
          ...
          <div className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 rounded-lg p-8">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                <strong className="text-emerald-700">Current State:</strong> Cultivate is in production, actively managing a portfolio of 16+ product ideas across all phases. The BOS Dashboard provides weekly planning and portfolio oversight. Several projects are in validation phase with demand tests running, and one project (Kinlet) has deployed to production.
              </p>
              <p>
                <strong className="text-emerald-700">Active Development:</strong> Continuously refining the agent orchestration system, consolidating rules, and improving quality gates based on real-world usage. Recent focus on better document discovery, automated workflow transitions, and portfolio analytics.
              </p>
              <p>
                <strong className="text-emerald-700">Roadmap Vision:</strong> Planning to open-source the core framework (agents, gates, workflows, document templates) so other founders can replicate this systematic approach. Building a community around product creation methodology, turning Cultivate from a personal tool into a platform.
              </p>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-emerald-500/30">
              <a
                ...
                className="inline-flex items-center gap-2 text-emerald-700 hover:text-emerald-300 transition-colors font-semibold text-lg"
              >
                View Live Platform →
              </a>
            </div>
        ...
        <section className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 rounded-lg p-8 text-center">
          ...
          <Link href="/contact?intent=consulting" className="inline-block px-8 py-3 bg-emerald-500 hover:bg-emerald-400 text-foreground font-semibold rounded-lg transition-colors cursor-pointer">
              Let's Talk
          </Link>
        </section>
      </div>
