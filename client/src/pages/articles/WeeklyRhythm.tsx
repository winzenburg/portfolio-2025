      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center mb-6">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">The Complete Weekly System</div>
                <div className="text-3xl font-bold text-foreground">Plan → Solve → Review</div>
              </div>
              <div className="grid md:grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-primary mb-1">15-30 min</div>
                  <div className="text-sm text-muted-foreground">Plan the week</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary mb-1">30-45 min</div>
                  <div className="text-sm text-muted-foreground">Solve top issues</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary mb-1">10-20 min</div>
                  <div className="text-sm text-muted-foreground">Review and learn</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Required Planning Outputs</div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Tasks (Avoid)</div>
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">"Talk to users"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Outcomes (Target)</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Ship onboarding checklist + empty state with one next action"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Run 5 walkthroughs, extract top 3 friction points"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
            ...
            <div className="my-10 bg-destructive/10 border border-destructive/30 rounded-lg p-8">
              <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Anti-Bloat Rules</div>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">1</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">10-minute escalation rule</div>
                    <div className="text-muted-foreground text-sm">If you can't agree in 10 minutes, escalate to deeper problem-solving.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">2</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Action cap</div>
                    <div className="text-muted-foreground text-sm">1-3 total actions, not 12 "follow-ups."</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">3</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Definition of done required</div>
                    <div className="text-muted-foreground text-sm">Every action has a done looks like and a date.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Review Example */}
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Example Review</div>
              <div className="space-y-4 text-muted-foreground">
                <div>
                  <span className="text-primary font-semibold">Key Learning:</span> Users who see the empty state copy complete onboarding 2x faster than those who see the feature checklist first.
                </div>
                <div>
                  <span className="text-primary font-semibold">Next Experiment:</span> Replace the multi-step onboarding with a single screen focused on one primary action.
                </div>
                <div>
                  <span className="text-primary font-semibold">System Improvement:</span> Add "empty state copy" to the launch checklist for all new features.
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Keep the cadence small: plan, solve, review, that's enough</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Outcomes beat task lists. Always write "done looks like"</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Protect time on the calendar before committing to outcomes</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">The review is where compounding happens: one learning + one experiment per week</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/rocks-not-tasks" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
