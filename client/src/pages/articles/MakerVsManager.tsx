      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Maker Mode</div>
                <div className="text-foreground font-semibold mb-3">Focused building</div>
              ...
              <div className="bg-muted/30 border border-border rounded-lg p-6">
                <div className="text-muted-foreground font-semibold mb-4 uppercase text-sm tracking-wider">Manager Mode</div>
                <div className="text-foreground font-semibold mb-3">Coordination</div>
                <div className="space-y-2 text-sm text-muted-foreground">
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Deep Work Block Requirements</div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Manager Work Windows</div>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-foreground mb-1">Comms</div>
                  <div className="text-sm text-muted-foreground">One window for messages/email</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-foreground mb-1">Admin</div>
                  <div className="text-sm text-muted-foreground">One window for operational tasks</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-foreground mb-1">Review</div>
                  <div className="text-sm text-muted-foreground">One window for approvals/feedback</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Sample Weekly Calendar</div>
              <div className="space-y-4 text-muted-foreground">
                <div className="flex items-start gap-4">
                  <div className="text-primary font-semibold w-20">Monday</div>
                  <div>Planning (15-30 min) + first deep work block</div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="text-primary font-semibold w-20">Tue/Wed</div>
                  <div>1-2 deep work blocks per day (most productive days)</div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="text-primary font-semibold w-20">Thursday</div>
                  <div>Issues meeting + one deep work block</div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="text-primary font-semibold w-20">Friday</div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">The calendar is the execution system, protect it before committing to outcomes</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Schedule 2-4 deep work blocks (60-180 min each) before anything else</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Batch manager work to reduce context switching costs</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Push meetings later in the week when possible</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">A BOS is only as real as the time you protect for shipping</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/ai-cost-control" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
