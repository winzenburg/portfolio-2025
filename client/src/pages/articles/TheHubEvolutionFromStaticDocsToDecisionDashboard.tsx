    ...
    >
      <div className="prose prose-gray max-w-none">
        ...
        <div className="bg-yellow-50 border border-yellow-200 p-6 rounded-lg my-8">
          ...
          <p className="text-yellow-700 font-medium">Time: ~30 minutes to get portfolio overview</p>

          <p className="text-yellow-800 mb-2 mt-4"><strong>Decision making:</strong></p>
          <ul className="text-yellow-700 mb-4">
          ...
          <p className="text-yellow-800 mb-2"><strong>Onboarding:</strong></p>
