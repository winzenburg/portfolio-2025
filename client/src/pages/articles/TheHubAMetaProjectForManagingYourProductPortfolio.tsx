      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            {/* Stats Card */}
            <div className="my-8 bg-primary/8 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Portfolio Snapshot</div>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <div className="text-3xl font-bold text-foreground mb-1">23</div>
                  <div className="text-muted-foreground text-sm">Active ideas tracked</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-1">$47K</div>
                  <div className="text-muted-foreground text-sm">Estimated MRR pipeline</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-foreground mb-1">6</div>
                  <div className="text-muted-foreground text-sm">Projects in validation</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-1">3</div>
                  <div className="text-muted-foreground text-sm">Ready for development</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span><code className="text-primary">/docs/discovery/</code> - All my market research</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><code className="text-primary">/docs/validation/</code> - Pricing tests, interviews, surveys</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><code className="text-primary">/docs/product/</code> - PRDs and technical specs</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><code className="text-primary">/docs/research/</code> - Competitive analysis</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><code className="text-primary">/docs/ideas/</code> - Raw brainstorms</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-2 uppercase text-sm tracking-wider">Before</div>
                <div className="text-muted-foreground">Managing 23 individual projects separately</div>
              </div>
              <div className="bg-primary/8 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-2 uppercase text-sm tracking-wider">After</div>
                <div className="text-muted-foreground font-semibold">Managing 1 portfolio with 23 components</div>
              </div>
            </div>
  ...
  /archive/`}
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="space-y-4">
                <div>
                  <div className="text-foreground font-semibold mb-2">Better Ideas</div>
                  <div className="text-muted-foreground text-sm">When you can see your entire portfolio at once, you start noticing gaps and opportunities you'd miss when tunnel-visioned on individual projects.</div>
                </div>
                <div>
                  <div className="text-foreground font-semibold mb-2">Faster Kills</div>
                  <div className="text-muted-foreground text-sm">It's easier to abandon a struggling project when you can see three better opportunities right next to it on the dashboard.</div>
                </div>
                <div>
                  <div className="text-foreground font-semibold mb-2">Pattern Recognition</div>
                  <div className="text-muted-foreground text-sm">I discovered I consistently underestimate discovery time but overestimate validation complexity. That insight changed how I plan new projects.</div>
                </div>
                <div>
                  <div className="text-foreground font-semibold mb-2">Less Anxiety</div>
                  <div className="text-muted-foreground text-sm">Knowing that nothing can get lost or forgotten in the system freed up mental energy for actual creative work.</div>
                </div>
              </div>
            </div>
            ...
            {/* Impact Metrics */}
            <div className="my-8 bg-primary/8 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Hub Impact Metrics</div>
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <div className="text-3xl font-bold text-foreground mb-1">73%</div>
                  <div className="text-muted-foreground text-sm">Reduction in time spent "finding stuff"</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-1">2.3x</div>
                  <div className="text-muted-foreground text-sm">Faster project status updates</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-foreground mb-1">5</div>
                  <div className="text-muted-foreground text-sm">Projects killed early (~40 hours saved each)</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-1">1</div>
                  <div className="text-muted-foreground text-sm">High-potential project rescued from abandonment</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Key Takeaways:</div>
          ...
          {/* CTA Card */}
          <div className="bg-primary/8 border border-primary/20 rounded-lg p-8 my-12">
            <h3 className="text-2xl font-bold text-foreground mb-4">Want to Build Your Own Hub?</h3>
