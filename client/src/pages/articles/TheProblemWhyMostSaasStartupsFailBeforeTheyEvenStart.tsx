      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6">
            ...
            <span>•</span>
            <span className="bg-primary/8 text-primary px-2 py-1 rounded text-xs font-medium">
              AI Workflow
            </span>
          </div>
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            <p className="text-muted-foreground leading-relaxed mb-6">
              What keeps me up at night: <strong className="text-foreground">90% of SaaS startups fail</strong>, and most never even had a fighting chance. Not because they had bad ideas, but because they had a bad process.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">The desirability toolkit is actually pretty simple:</p>

            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Fake door campaigns</strong>: "Coming soon" landing pages to test demand signals</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Concierge MVPs</strong>: Manually deliver the service to test core value prop</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Preorder offers</strong>: Will people actually pay before it exists?</span>
                </li>
              </ul>
            </div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">Month 18? Down to 47 active users.</p>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center mb-6">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">The Durability Assessment Framework</div>
                <div className="text-lg text-foreground mb-4">Score each factor 1-5, total score determines durability:</div>
              </div>
              <div className="space-y-3 text-muted-foreground mb-6">
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">•</span>
                  <span><strong className="text-foreground">Frequency of the Job</strong>: Daily/weekly vs. one-time use</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">•</span>
                  <span><strong className="text-foreground">Economic Buyer Has Budget</strong>: Budgeted vs. discretionary spend</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">•</span>
                  <span><strong className="text-foreground">Problem Exists Independent of Hype</strong>: Structural vs. trend-driven</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">•</span>
                  <span><strong className="text-foreground">Users Would Miss It</strong>: Critical vs. nice-to-have</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">•</span>
                  <span><strong className="text-foreground">Clear Path to Switching Costs</strong>: Deep integration potential</span>
                </div>
              </div>
              <div className="bg-primary/8 border border-primary/20 rounded-lg p-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-primary mb-1">18+ = Durable market</div>
                  <div className="text-sm text-muted-foreground mb-2">(build this)</div>
                  <div className="text-xl font-bold text-destructive mb-1">10- = Low durability</div>
                  <div className="text-sm text-muted-foreground">(tread carefully)</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">❌ Single Bet</div>
              ...
              <div className="bg-primary/8 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">✅ Portfolio</div>
                <ul className="space-y-3 text-muted-foreground text-sm">
                  <li className="flex items-start gap-2">
                    <span className="text-primary mt-1">•</span>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">The solution? A comprehensive knowledge system that captures:</p>

            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Insight & Narrative Briefs</strong>: Why this idea matters and to whom</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Validation Playbooks</strong>: Repeatable frameworks for testing demand</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Durability Assessments</strong>: Systematic approach to long-term viability</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Implementation Guides</strong>: From validated idea to shipped feature</span>
                </li>
              </ul>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-muted-foreground text-sm">Will they still want it and keep paying 12-36 months from now? Does it score 18+ on the durability assessment? This is your stickiness signal.</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center mb-6">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">The Complete System</div>
                <div className="text-2xl font-bold text-foreground">Four Phases</div>
              </div>
              <div className="space-y-4 text-muted-foreground">
                <div className="flex items-start gap-3">
                  <span className="text-primary font-bold">1.</span>
                  <div>
                    <strong className="text-foreground">Insight & Narrative</strong> → Validate tribe + urgent problem (Heat Filter)
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary font-bold">2.</span>
                  <div>
                    <strong className="text-foreground">Durability Assessment</strong> → Assess 12-36 month viability (Durability Filter)
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary font-bold">3.</span>
                  <div>
                    <strong className="text-foreground">Experience Design</strong> → Design workflows that deliver the narrative
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary font-bold">4.</span>
                  <div>
                    <strong className="text-foreground">MVP Engineering</strong> → Build smallest viable test of core value prop
                  </div>
                </div>
              </div>
            </div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">If you take nothing else from this, remember these four things:</p>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-4 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">1.</span>
                  <div>
                    <strong className="text-foreground">Validate both filters</strong> → Don't just prove people want it now. Prove they'll still want it next year.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">2.</span>
                  <div>
                    <strong className="text-foreground">Document everything</strong> → Your future self (and your team) will thank you when knowledge doesn't walk out the door.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">3.</span>
                  <div>
                    <strong className="text-foreground">Use AI systematically</strong> → Powerful tools, proper workflows, human verification. AI amplifies good process and exposes bad process.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">4.</span>
                  <div>
                    <strong className="text-foreground">Diversify your bets</strong> → Run multiple ideas through the same systematic process. Portfolio thinking protects you from individual failures.
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">•</span>
                  <div>
                    <strong className="text-foreground">Upfront investment</strong> → Building a comprehensive validation system takes time and resources you might not have.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">•</span>
                  <div>
                    <strong className="text-foreground">Slower initial iteration</strong> → Rigorous validation can feel slow when you see competitors shipping fast (even if they're shipping the wrong things).
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">•</span>
                  <div>
                    <strong className="text-foreground">Complexity management</strong> → Coordinating multiple validation tracks requires discipline and clear communication.
                  </div>
                </li>
              </ul>
            </div>
