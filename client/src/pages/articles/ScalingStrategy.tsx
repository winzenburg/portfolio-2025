        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-muted/50 border-l-4 border-blue-500 px-6 pt-4 pb-5">
            ...
            <div className="my-10 bg-destructive/10 border border-destructive/30 rounded-lg p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Building too many products too fast</div>
                    <div className="text-muted-foreground text-sm">The temptation is to launch everything simultaneously. I tried this. It's a disaster. Diluted focus means nothing gets the attention it needs to succeed. Better to nail one product completely, prove the model, build the automation infrastructure, and then expand methodically.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">2</span>
                  <div>
                    <div className="text-foreground font-semibold mb-2">Not building shared infrastructure from day one</div>
                    <div className="text-muted-foreground text-sm">I watched a team put each product on a different tech stack. Authentication, billing, data storage, all different for each product. The integration nightmare nearly killed the company. Now I architect for portfolio from the beginning. Shared infrastructure isn't optional.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">3</span>
                  <div>
                    <div className="text-foreground font-semibold mb-2">Under-investing in automation</div>
                    <div className="text-muted-foreground text-sm">Manual operations don't scale across multiple products. Period. The mistake is treating automation as something you add later. It needs to be front-loaded. Every hour you invest in automation early pays back exponentially as you add products.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Traditional Single-Product Approach</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Revenue concentration risk</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Linear scaling challenges</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Limited cross-sell opportunities</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Slower growth trajectory</span>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-border rounded-lg p-8 my-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">I've implemented this scaling strategy across multiple businesses. Let's discuss how to apply these principles to your specific context.</p>
