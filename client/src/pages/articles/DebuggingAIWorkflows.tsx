      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="mb-12 rounded-lg overflow-hidden">
            <img
              src="/images/articles/debugging-ai-workflows-hero.webp"
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">You Need To Know</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">What input did we send?</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">What output did we receive?</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">When did we send it?</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">What failed (category)?</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">What is the recovery path?</span>
                  </div>
                </div>
              </div>
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">You Don't Need</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Full raw prompts everywhere</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Secret keys in logs</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">A giant admin UI</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">PII in debugging logs</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Unstructured log streams</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Snapshot Record Structure</div>
              <div className="space-y-2 text-muted-foreground font-mono text-sm">
                <div><span className="text-primary">attemptId:</span> unique identifier for this attempt</div>
                <div><span className="text-primary">runId / stepId:</span> context within the workflow</div>
                <div><span className="text-primary">timestamps:</span> started, finished</div>
                <div><span className="text-primary">request:</span> metadata (not secrets)</div>
                <div><span className="text-primary">response:</span> status, size</div>
                <div><span className="text-primary">artifactPath:</span> pointer to stored raw output</div>
                <div><span className="text-primary">errorCategory:</span> timeout | invalid_output | unauthorized | ...</div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Debug Endpoint Requirements</div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Error Taxonomy</div>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded text-sm">timeout</code>
                  <span className="text-muted-foreground text-sm">Operation took too long</span>
                </div>
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded text-sm">unauthorized</code>
                  <span className="text-muted-foreground text-sm">Auth/permission issue</span>
                </div>
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded text-sm">quota_exceeded</code>
                  <span className="text-muted-foreground text-sm">Hit rate or budget limits</span>
                </div>
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded text-sm">invalid_format</code>
                  <span className="text-muted-foreground text-sm">Output didn't match schema</span>
                </div>
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded text-sm">upstream_error</code>
                  <span className="text-muted-foreground text-sm">Provider returned error</span>
                </div>
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded text-sm">storage_error</code>
                  <span className="text-muted-foreground text-sm">Couldn't save output</span>
                </div>
              </div>
            </div>
            ...
            {/* Debug Checklist */}
            <div className="my-10 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Pre-Ship Debug Checklist</div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Debugging AI is about evidence and recovery, not more retries</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Snapshots turn messy failures into discrete events you can reason about</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Fetch-by-id endpoints reduce cost and make recovery possible</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Constrain debug tooling with auth, rate limits, and audit logs</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Normalize errors into a small taxonomy with recovery actions</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            <p className="text-muted-foreground mb-4">Continue Reading</p>
            <Link href="/articles/design-systems-fail" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
