        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0">
            ...
            <div className="my-8 bg-muted border border-primary/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-primary mb-4">What faster exploration makes possible</h3>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              The real question is: <strong className="text-foreground">Have we created an environment where good people can test useful ideas quickly?</strong>
            </p>
            ...
            <div className="my-8 bg-muted rounded-lg p-6">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  <div className="text-muted-foreground text-sm uppercase tracking-wide mb-2">Old bottleneck</div>
                  <div className="text-2xl font-bold text-muted-foreground">Can we build it?</div>
                </div>
                <div className="text-center">
                  <div className="text-primary text-sm uppercase tracking-wide mb-2">New bottleneck</div>
                  <div className="text-2xl font-bold text-foreground">Should we build it?</div>
                </div>
              </div>
            </div>

            <p className="text-muted-foreground leading-relaxed mb-6">
              That's a human question. It requires judgment. It requires deep user empathy. It requires clarity about what actually matters. So another question worth asking: <strong className="text-foreground">Do we have enough judgment inside the organization to know what's worth building?</strong>
            </p>
