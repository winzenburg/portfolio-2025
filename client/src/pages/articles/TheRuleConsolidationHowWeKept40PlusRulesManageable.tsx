...
export default function RuleConsolidation() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <Helmet>
        <title>The Rule Consolidation: How We Kept 40+ Rules Manageable Without Losing Power | Ryan Winzenburg</title>
        <meta name="description" content="Most systems collapse under their own complexity. Here&#39;s how we prevented that with a unified taxonomy and single foreman orchestrator." />
      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Crucially, <strong className="text-foreground">we didn't simplify by cutting capabilities</strong>. We consolidated without losing a single feature, validation gate, or quality check. And more importantly, we built systems to keep it that way.
            </p>
            ...
            {/* Symptoms Card */}
            <div className="my-8 bg-destructive/20 border border-red-700/50 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-destructive mb-4">The Symptoms of Rule Sprawl</h3>
              <ul className="space-y-3 text-red-300">
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">•</span>
                  <span><strong className="text-foreground">Duplicate rules everywhere:</strong> Cursor agent responsibilities in both 003 and 028 series</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">•</span>
                  <span><strong className="text-foreground">Unclear ownership:</strong> Six different Hub implementation rules (132, 133, 134, 136, 137, 200)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">•</span>
                  <span><strong className="text-foreground">Numbering collisions:</strong> Two different rules both labeled 198</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">•</span>
                  <span><strong className="text-foreground">Agent confusion:</strong> "How do I integrate ChatGPT?" had five different answers</span>
                </li>
              </ul>
            </div>
            ...
            <div className="my-8 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-primary/20 rounded-lg p-6">
                <h4 className="font-semibold text-primary mb-2">Core Guardrails (000-099)</h4>
              ...
              <div className="bg-muted/30 border border-border rounded-lg p-6">
                <h4 className="font-semibold text-green-700 mb-2">Discovery Pack (300-340)</h4>
                <p className="text-muted-foreground text-sm">Templates and AI orchestration specific to the heat filter phase. Only loaded when Discovery pod is active.</p>
              </div>
            </div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              We designated <code className="text-primary bg-muted/50 px-2 py-1 rounded">000-orchestration.mdc</code> as the single "foreman" managing the entire workflow. Instead of each agent trying to figure out which rules apply, the foreman:
            </p>
            ...
            <div className="my-8 overflow-x-auto">
              <table className="min-w-full bg-muted/30 border border-border text-sm rounded-lg">
                <thead className="bg-muted/50">
                  <tr>
                    <th className="px-4 py-3 border-b border-border text-left font-medium text-muted-foreground">Rule</th>
                    <th className="px-4 py-3 border-b border-border text-left font-medium text-muted-foreground">Type</th>
                    <th className="px-4 py-3 border-b border-border text-left font-medium text-muted-foreground">Phase</th>
                    <th className="px-4 py-3 border-b border-border text-left font-medium text-muted-foreground">Primary Agents</th>
                    <th className="px-4 py-3 border-b border-border text-left font-medium text-muted-foreground">Status</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="px-4 py-3 border-b border-border font-mono text-xs text-primary">000-orchestration</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">Core</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">All</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">Orchestrator</td>
                    <td className="px-4 py-3 border-b border-border text-green-700">Active</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 border-b border-border font-mono text-xs text-primary">118-brand-landscape</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">Stack</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">Validation → Build</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">Brand Strategist</td>
                    <td className="px-4 py-3 border-b border-border text-green-700">Active</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-3 border-b border-border font-mono text-xs text-primary">050-manus-integration</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">Meta</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">N/A</td>
                    <td className="px-4 py-3 border-b border-border text-muted-foreground">(see 190)</td>
                    <td className="px-4 py-3 border-b border-border text-destructive">Deprecated</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="my-8 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-3 uppercase text-sm tracking-wider">Before: The AI Tool Integration Disaster</div>
                <ul className="text-sm text-muted-foreground space-y-1">
                  <li><code className="text-destructive">050-manus-integration.mdc</code></li>
                  <li><code className="text-destructive">060-chatgpt-refinement.mdc</code></li>
                  <li><code className="text-destructive">070-elevenlabs-integration.mdc</code></li>
                  <li><code className="text-destructive">080-midjourney-canva.mdc</code></li>
                  <li className="text-muted-foreground">Plus duplicates in the 300s for discovery-specific prompts</li>
                </ul>
              </div>
              <div className="bg-primary/8 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-3 uppercase text-sm tracking-wider">After: One Canonical Source</div>
                <div className="text-sm text-muted-foreground font-mono bg-muted/50 p-3 rounded">
                  <div className="text-primary"># Rule 190: AI Tool Integrations</div>
            ...
            <div className="my-6 bg-muted/50 border-l-4 border-yellow-400 p-4">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Same story with the Hub implementation chaos. Six separate rules became one comprehensive <code className="text-primary bg-muted/50 px-2 py-1 rounded">200-hub-implementation.mdc</code> with subsections for document discovery, workflow linkage, UI conventions, and API patterns.
            </p>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><code className="text-primary">198-ai-prompt-templates.mdc</code> → <code className="text-green-700">199-ai-prompt-templates.mdc</code></span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><code className="text-primary">199-ai-error-handling.mdc</code> → <code className="text-green-700">201-ai-error-handling.mdc</code></span>
                </li>
              </ul>
            </div>
            ...
            <div className="my-6 bg-muted text-green-700 p-4 rounded-lg font-mono text-sm">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              We created <code className="text-primary bg-muted/50 px-2 py-1 rounded">docs/rules/change-control.md</code>, a lightweight checklist for future changes:
            </p>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ol className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-foreground">Before You Edit:</strong> Clarify tier, identify owners, check for duplicates</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">2.</span>
                  <span><strong className="text-foreground">While Editing:</strong> Use standard format, include lifecycle/agents/deliverables sections</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">3.</span>
                  <span><strong className="text-foreground">After Saving:</strong> Update matrix, patch orchestrator, log in blueprint</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary font-bold">4.</span>
                  <span><strong className="text-foreground">Acceptance Tests:</strong> Verify no duplicates, test all links</span>
                </li>
              </ol>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <h3 className="text-lg font-semibold mb-6 text-center text-foreground">Before vs. After</h3>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h4 className="font-semibold text-destructive mb-3">Before: The Chaos</h4>
                ...
                <div>
                  <h4 className="font-semibold text-primary mb-3">After: The Order</h4>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">Impact</div>
                <div className="text-3xl font-bold text-foreground mb-2">Zero capability loss</div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Universal constraints</strong> (apply to everyone, always)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Specialist tools</strong> (apply to specific roles/agents)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Workflows</strong> (multi-step processes with handoffs)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span><strong className="text-foreground">Templates</strong> (reusable starting points)</span>
                </li>
              </ul>
            </div>
