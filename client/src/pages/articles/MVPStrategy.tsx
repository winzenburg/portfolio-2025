        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="bg-muted/50 border border-border rounded-lg p-6 my-8">
              <p className="text-primary font-semibold mb-2">Example:</p>
              <p className="text-foreground text-lg">"AI-powered design system builder that goes from concept to production in 4 weeks instead of 12 months."</p>
              <p className="text-muted-foreground mt-4 text-sm">Clear. Specific. Quantified.</p>
            </div>
            ...
            <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-6 my-8">
              <p className="text-destructive font-semibold mb-2 uppercase text-sm tracking-wider">The mistake to avoid</p>
              <p className="text-muted-foreground">Feature bloat. Every additional feature delays launch and dilutes value. Ship the minimum, learn from users, then iterate.</p>
            </div>
            ...
            <div className="space-y-4 mb-10">
              <div className="bg-muted/50 border-l-4 border-blue-500 p-4">
                <h4 className="text-foreground font-semibold mb-2">Week 1: Private Beta</h4>
                <p className="text-muted-foreground">Launch to 50-100 users. Focus on core feature validation and early feedback.</p>
              </div>
              <div className="bg-muted/50 border-l-4 border-blue-500 p-4">
                <h4 className="text-foreground font-semibold mb-2">Week 2: Iterate Fast</h4>
                <p className="text-muted-foreground">Gather feedback, fix critical issues, refine user experience based on real usage.</p>
              </div>
              <div className="bg-muted/50 border-l-4 border-blue-500 p-4">
                <h4 className="text-foreground font-semibold mb-2">Week 3: Expand</h4>
                <p className="text-muted-foreground">Grow to 500-1000 users. Monitor performance and scale infrastructure.</p>
              </div>
              <div className="bg-muted/50 border-l-4 border-blue-500 p-4">
                <h4 className="text-foreground font-semibold mb-2">Week 4: Public Launch</h4>
                <p className="text-muted-foreground">Go public with refined product. Activate marketing and growth channels.</p>
              </div>
            </div>
            ...
            <div className="my-10 bg-destructive/10 border border-destructive/30 rounded-lg p-8">
              <div className="text-destructive font-semibold mb-6 uppercase text-sm tracking-wider">Key Mistakes to Avoid</div>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">1</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Building too many features before launch</div>
                    <div className="text-muted-foreground text-sm">Delayed our launch by 2 months. Users only wanted the core feature.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">2</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Ignoring user feedback</div>
                    <div className="text-muted-foreground text-sm">Built features users didn't ask for. Wasted development time.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">3</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Launching without distribution plan</div>
                    <div className="text-muted-foreground text-sm">Great product, no audience. Now build audience in parallel with product.</div>
                  </div>
                </div>
              </div>
            </div>
