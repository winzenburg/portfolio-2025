        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0">
            ...
            <div className="my-8 bg-muted border border-primary/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-primary mb-5">Three ways this goes wrong</h3>
              <div className="space-y-6">
                <div>
                  <div className="text-foreground font-semibold mb-2">Automating a broken workflow</div>
                ...
                <div>
                  <div className="text-foreground font-semibold mb-2">Designing for magic instead of reliability</div>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                <div>
                  <div className="text-foreground font-semibold mb-2">Treating "a person will check it" as a control system</div>
                  <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-cyan-800/40 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Decision-support agent</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Assemble evidence, surface alternatives, name the gaps, preserve provenance</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Quietly make the call</span>
                  </div>
                </div>
              </div>
              <div className="bg-muted/30 border border-cyan-800/40 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Financial operations agent</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Monitor, reconcile, explain, and flag exceptions</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Present an unverified conclusion as advice</span>
                  </div>
                </div>
              </div>
            </div>
