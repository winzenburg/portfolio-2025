      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 grid md:grid-cols-3 gap-6">
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-2 uppercase text-sm tracking-wider">Gate 1</div>
                <div className="text-foreground font-bold text-xl mb-3">Schema</div>
                <div className="text-muted-foreground text-sm">Does the output have the shape you need? Validate structure before anything else.</div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-2 uppercase text-sm tracking-wider">Gate 2</div>
                <div className="text-foreground font-bold text-xl mb-3">Normalization</div>
                <div className="text-muted-foreground text-sm">Is the output formatted consistently? Transform machine output into human artifact.</div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-2 uppercase text-sm tracking-wider">Gate 3</div>
                <div className="text-foreground font-bold text-xl mb-3">Rendering</div>
                <div className="text-muted-foreground text-sm">Is it readable and navigable for humans? This is where output becomes usable.</div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Schema Validation Requirements</div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Common Normalization Steps</div>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex items-start gap-3">
                  <span className="text-primary">•</span>
                  <span className="text-muted-foreground">Headings follow predictable hierarchy</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary">•</span>
                  <span className="text-muted-foreground">Bullet lists are actually lists</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary">•</span>
                  <span className="text-muted-foreground">JSON wrapped in fenced code blocks</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary">•</span>
                  <span className="text-muted-foreground">JSON pretty-printed with indentation</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary">•</span>
                  <span className="text-muted-foreground">Consistent section names enforced</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary">•</span>
                  <span className="text-muted-foreground">Whitespace and newlines standardized</span>
                </div>
              </div>
            </div>
            ...
            {/* Rendering Features */}
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Rendering Features That Matter</div>
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
            ...
            <div className="my-10 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">AI Output Contract Template</div>
              <div className="space-y-4 text-muted-foreground font-mono text-sm">
                <div><span className="text-primary">Expected types:</span> [doc, json, attachments, etc.]</div>
                <div><span className="text-primary">Required fields:</span> [if structured, what must be present]</div>
                <div><span className="text-primary">Normalization rules:</span> [formatting expectations]</div>
                <div><span className="text-primary">Rendering expectations:</span> [how it will appear to users]</div>
              </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Treat AI output as untrusted input, it's raw material, not finished product</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Validate shape (schema), normalize formatting, and render for humans</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Store raw output as a fallback and for debugging</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Start minimal, a few checks and formatting rules go a long way</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/debugging-ai-workflows" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
