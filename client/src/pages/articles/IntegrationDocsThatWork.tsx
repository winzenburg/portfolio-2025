        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-8 bg-destructive/10 border border-destructive/30 rounded-lg p-6">
              <div className="text-destructive font-semibold mb-4">❌ Traditional API Doc Structure</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">6.</span>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">✓ Goal-Oriented Doc Structure</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">1.</span>
                  <span><strong className="text-foreground">Quick Start:</strong> Working code in under 5 minutes</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">2.</span>
                  <span><strong className="text-foreground">Common Tasks:</strong> "How do I..." guides for frequent use cases</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">3.</span>
                  <span><strong className="text-foreground">Integration Guides:</strong> Complete implementations for popular frameworks</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">4.</span>
                  <span><strong className="text-foreground">Cookbook:</strong> Copy-paste solutions for specific scenarios</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">5.</span>
                  <span><strong className="text-foreground">Reference:</strong> Comprehensive endpoint docs (for when you need details)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Quick Start Must Include:</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Installation:</strong> One command. Not 5 steps.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Authentication:</strong> Working API key example. Not a conceptual explanation.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">First API Call:</strong> The simplest possible request that returns real data.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Success Confirmation:</strong> "You should see..." with exact expected output.
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-8">
              <div className="text-primary font-semibold mb-4">Quick Start (Takes 4 Minutes)</div>
              
              <div className="space-y-6 text-sm">
                <div>
                  <div className="text-foreground font-semibold mb-2">1. Install (30 seconds)</div>
                  <pre className="bg-background border border-border rounded p-3 text-xs text-muted-foreground overflow-x-auto">
{`npm install @yourapi/client`}
                  </pre>
                </div>

                <div>
                  <div className="text-foreground font-semibold mb-2">2. Get your API key (1 minute)</div>
                  <p className="text-muted-foreground mb-2">Get your test API key from: <span className="text-primary">dashboard.yourapi.com/keys</span></p>
                </div>

                <div>
                  <div className="text-foreground font-semibold mb-2">3. Make your first request (2 minutes)</div>
                  <pre className="bg-background border border-border rounded p-3 text-xs text-muted-foreground overflow-x-auto">
...
// { id: "acc_123", name: "Test Account", status: "active" }`}
                ...
                <div>
                  <div className="text-foreground font-semibold mb-2">4. You should see:</div>
                  <pre className="bg-background border border-green-300 rounded p-3 text-xs text-green-700">
{`✓ Account ID: acc_123
✓ Status: active
...
Success! You're ready to integrate.`}
              ...
              <div className="mt-6 pt-6 border-t border-border">
                <div className="text-muted-foreground text-sm">
                  <strong className="text-foreground">Next:</strong> See <a href="#" className="text-primary hover:text-primary">Common Tasks</a> for creating payments, handling webhooks, and more.
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">Common Tasks Format (Per Task):</div>
              <div className="space-y-4 text-sm">
                <div>
                  <div className="text-foreground font-semibold mb-1">1. Goal Statement</div>
                  <p className="text-muted-foreground">"Learn how to create a payment and handle the response"</p>
                </div>
                <div>
                  <div className="text-foreground font-semibold mb-1">2. Working Code</div>
                  <p className="text-muted-foreground">Complete, runnable example (not pseudocode)</p>
                </div>
                <div>
                  <div className="text-foreground font-semibold mb-1">3. What's Happening</div>
                  <p className="text-muted-foreground">Line-by-line explanation of key parts</p>
                </div>
                <div>
                  <div className="text-foreground font-semibold mb-1">4. Common Variations</div>
                  <p className="text-muted-foreground">"To accept Apple Pay, change payment_method to..."</p>
                </div>
                <div>
                  <div className="text-foreground font-semibold mb-1">5. Next Steps</div>
                  <p className="text-muted-foreground">Link to related tasks ("Now learn how to refund a payment")</p>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Cookbook Recipe Structure:</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Problem:</strong> "I need to implement webhook verification in Express.js"
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Solution:</strong> Complete middleware implementation (50-100 lines)
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">What to Modify:</strong> "Change WEBHOOK_SECRET to your actual secret"
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Testing:</strong> How to verify it works
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4">❌ Bad Error Message</div>
                <pre className="bg-background border border-border rounded p-3 text-xs text-destructive mb-3">
{`{
  "error": "invalid_request",
  "code": 400
}`}
                </pre>
                <p className="text-muted-foreground text-sm">What's invalid? How do I fix it? No idea.</p>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4">✓ Good Error Message</div>
                <pre className="bg-background border border-border rounded p-3 text-xs text-primary mb-3">
{`{
  "error": "invalid_request",
  ...
  "docs_url": "api.com/errors#amount-format"
                ...
                <p className="text-muted-foreground text-sm">Exactly what's wrong, how to fix it, where to learn more.</p>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Framework Guides to Create:</div>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">20-Minute Integration Test:</div>
            ...
            <div className="my-10 grid md:grid-cols-3 gap-6">
              <div className="bg-muted/50 border border-border rounded-lg p-6">
                <div className="text-primary font-semibold mb-2">Time to First API Call</div>
                <div className="text-4xl font-bold text-foreground mb-2">&lt;10min</div>
                <div className="text-muted-foreground text-sm">From landing on docs to successful request</div>
              </div>
              <div className="bg-muted/50 border border-border rounded-lg p-6">
                <div className="text-primary font-semibold mb-2">Quick Start Completion</div>
                <div className="text-4xl font-bold text-foreground mb-2">&gt;80%</div>
                <div className="text-muted-foreground text-sm">Percentage who complete Quick Start</div>
              </div>
              <div className="bg-muted/50 border border-border rounded-lg p-6">
                <div className="text-primary font-semibold mb-2">Support Ticket Rate</div>
                <div className="text-4xl font-bold text-foreground mb-2">&lt;5%</div>
                <div className="text-muted-foreground text-sm">Developers who need support vs those who don't</div>
              </div>
            </div>
            ...
            <div className="my-10 bg-destructive/10 border border-destructive/30 rounded-lg p-8">
              <div className="space-y-6">
                <div>
                  <div className="text-destructive font-semibold mb-2">Mistake 1: Starting with Concepts</div>
                  <p className="text-muted-foreground text-sm">Developers don't care about your architecture until they have working code. Quick Start first, concepts later.</p>
                </div>
                <div className="h-px bg-destructive/30"></div>
                <div>
                  <div className="text-destructive font-semibold mb-2">Mistake 2: Pseudocode Examples</div>
                  <p className="text-muted-foreground text-sm">"Here's the general pattern..." doesn't help. Give complete, runnable code.</p>
                </div>
                <div className="h-px bg-destructive/30"></div>
                <div>
                  <div className="text-destructive font-semibold mb-2">Mistake 3: Assuming Knowledge</div>
                  <p className="text-muted-foreground text-sm">"Obviously you'll need to configure webhooks" isn't obvious. Show exactly how.</p>
                </div>
                <div className="h-px bg-destructive/30"></div>
                <div>
                  <div className="text-destructive font-semibold mb-2">Mistake 4: No Expected Output</div>
                  <p className="text-muted-foreground text-sm">Always show what success looks like. "You should see..." with exact output.</p>
                </div>
              </div>
            </div>
            ...
            <div className="my-12 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">Developer Experience</div>
          ...
          <div className="bg-primary/8 border border-primary/20 rounded-lg p-8 my-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">Let's discuss how to design integration experiences that reduce time-to-value.</p>
