      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-green-500/20 border border-green-500 flex items-center justify-center text-green-700 font-bold">
                    0-30m
                  </div>
                  <div>
                    <div className="text-foreground font-semibold mb-2">Golden Hour</div>
                    <p className="text-muted-foreground text-sm">Agent is fresh, context is clean, decisions are sharp. This is when you get the best code.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Accumulation Phase</div>
                    <p className="text-muted-foreground text-sm">Context grows. Some decisions, corrections, and explorations that didn't pan out. Agent still functional but starting to carry baggage.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Degradation</div>
                    <p className="text-muted-foreground text-sm">Agent starts referencing old decisions that are no longer relevant. Occasionally suggests code patterns you explicitly rejected earlier.</p>
                  </div>
                </div>

                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-red-500/20 border border-red-500 flex items-center justify-center text-destructive font-bold">
                    3h+
                  </div>
                  <div>
                    <div className="text-foreground font-semibold mb-2">Context Pollution</div>
                    <p className="text-muted-foreground text-sm">Agent is confused. Makes mistakes it wouldn't make fresh. References code that doesn't exist. Forgets key constraints. Time to start over.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="space-y-4">
                <div>
                  <div className="text-primary font-semibold mb-2">Story 1: Start Fresh</div>
                  <p className="text-muted-foreground text-sm">Agent reads: story definition, acceptance criteria, relevant codebase context. Implements. Tests. Commits. <span className="text-primary">→ Context destroyed</span></p>
                </div>
                <div className="h-px bg-border"></div>
                <div>
                  <div className="text-primary font-semibold mb-2">Story 2: Start Fresh Again</div>
                  <p className="text-muted-foreground text-sm">New agent instance. Reads: story definition, acceptance criteria, relevant codebase context (including Story 1 results). Implements. Tests. Commits. <span className="text-primary">→ Context destroyed</span></p>
                </div>
                <div className="h-px bg-border"></div>
                <div>
                  <div className="text-primary font-semibold mb-2">Story 3: Start Fresh Again</div>
                  <p className="text-muted-foreground text-sm">Another new instance. Same pattern. No accumulated context pollution from Story 1 or 2.</p>
                </div>
              </div>
            </div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4">❌ Interactive Session Context</div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">•</span>
                    <span className="text-muted-foreground">All conversation history from Stories 1-4</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">•</span>
                    <span className="text-muted-foreground">False starts and rejected approaches</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">•</span>
                    <span className="text-muted-foreground">Debugging conversations</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">•</span>
                    <span className="text-muted-foreground">Corrections and refinements</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">•</span>
              ...
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-muted-foreground">Story 5 requirements</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-muted-foreground">Current codebase state (with Stories 1-4 merged)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-muted-foreground">Relevant code patterns to reference</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">•</span>
                    <span className="text-muted-foreground">Acceptance criteria for validation</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">•</span>
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-8">
              <div className="text-destructive font-semibold mb-4">Interactive Session (4 hours)</div>
              
              <div className="space-y-4 text-sm">
                <div className="bg-muted/50 border border-border rounded p-4">
                  <div className="text-foreground mb-2">Hour 1: Building User Settings Form</div>
                  <p className="text-muted-foreground">Agent suggests validation pattern. I reject it, request a different approach. We implement Plan B. <span className="text-green-700">✓ Works great</span></p>
                </div>
                ...
                <div className="bg-muted/50 border border-border rounded p-4">
                  <div className="text-foreground mb-2">Hour 4: Building Profile Settings Form</div>
                  <p className="text-muted-foreground">Agent is confused. Mixes patterns from all three previous forms. References both rejected Plan A AND current Plan B approaches. Creates hybrid that doesn't work. I spend 40 minutes untangling. <span className="text-destructive">✗ Severe pollution</span></p>
                </div>
              </div>

              <div className="mt-6 pt-4 border-t border-border">
                <div className="text-foreground font-semibold mb-2">Result:</div>
                <p className="text-muted-foreground text-sm">4 forms built in 4 hours. Last 2 hours less productive than first 2 hours. Had to start fresh session for form 5.</p>
              </div>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-primary font-semibold mb-4">Autonomous Build (Overnight)</div>
              
              <div className="space-y-4 text-sm">
                <div className="bg-muted/50 border border-cyan-800/30 rounded p-4">
                  <div className="text-foreground mb-2">Story 1: User Settings Form</div>
                  <p className="text-muted-foreground">PRD specifies validation approach. Agent implements exactly as specified. Fresh context. <span className="text-green-700">✓ Perfect</span></p>
                </div>

                <div className="bg-muted/50 border border-cyan-800/30 rounded p-4">
                  <div className="text-foreground mb-2">Story 2: Admin Settings Form</div>
                  <p className="text-muted-foreground">New agent instance. Reads PRD: "Follow validation pattern from UserSettingsForm.tsx". Sees completed code from Story 1. Replicates. Fresh context. <span className="text-green-700">✓ Perfect</span></p>
                </div>

                <div className="bg-muted/50 border border-cyan-800/30 rounded p-4">
                  <div className="text-foreground mb-2">Story 3: Account Settings Form</div>
                  <p className="text-muted-foreground">Another new instance. Same pattern reference. No memory of false starts or rejected approaches. Just clean implementation. Fresh context. <span className="text-green-700">✓ Perfect</span></p>
                </div>

                <div className="bg-muted/50 border border-cyan-800/30 rounded p-4">
                  <div className="text-foreground mb-2">Story 4: Profile Settings Form</div>
                  <p className="text-muted-foreground">Yet another fresh instance. Pattern is now proven 3 times. Agent replicates cleanly. No confusion. Fresh context. <span className="text-green-700">✓ Perfect</span></p>
                </div>
              </div>

              <div className="mt-6 pt-4 border-t border-primary/20">
                <div className="text-foreground font-semibold mb-2">Result:</div>
                <p className="text-muted-foreground text-sm">4 forms built overnight, each with same quality as the first. Form 4 took the same time as Form 1. No degradation. Cost: $32 total.</p>
              </div>
            </div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/50 border border-border rounded-lg p-6">
                <div className="text-foreground font-semibold mb-4">Interactive Session Quality</div>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">First 30 minutes:</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Hour 1-2:</span>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Hour 2-3:</span>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Hour 3+:</span>
                    <div className="flex items-center gap-2">
                ...
                <div className="mt-4 pt-4 border-t border-border">
                  <div className="text-foreground font-semibold">Average Quality: 75%</div>
                </div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4">Autonomous Fresh Context</div>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Story 1:</span>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Story 5:</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-2 bg-primary rounded"></div>
                      <span className="text-foreground">95%</span>
                    </div>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Story 10:</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-2 bg-primary rounded"></div>
                      <span className="text-foreground">95%</span>
                    </div>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-muted-foreground">Story 15:</span>
                    <div className="flex items-center gap-2">
                      <div className="w-24 h-2 bg-primary rounded"></div>
                      <span className="text-foreground">95%</span>
                    </div>
                ...
                <div className="mt-4 pt-4 border-t border-primary/20">
                  <div className="text-foreground font-semibold">Average Quality: 95%</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Exploration:</strong> When you're figuring out what to build, interactive feedback is invaluable
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Learning:</strong> Working through an unfamiliar codebase with real-time guidance
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Debugging:</strong> Tracing through complex issues where context matters
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Quick tasks:</strong> Sub-30-minute changes where fresh context overhead isn't worth it
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="space-y-4">
                <div>
                  <div className="text-primary font-semibold mb-2">Phase 1: Interactive Exploration (1-2 hours)</div>
                  <p className="text-muted-foreground text-sm">Use interactive mode to prototype the first implementation. Establish patterns. Figure out the right approach. Get something working.</p>
                </div>
                <div className="h-px bg-border"></div>
                <div>
                  <div className="text-primary font-semibold mb-2">Phase 2: Document the Pattern (30 minutes)</div>
                  <p className="text-muted-foreground text-sm">Capture what you learned. Write clear requirements. Specify the pattern you want replicated.</p>
                </div>
                <div className="h-px bg-border"></div>
                <div>
                  <div className="text-primary font-semibold mb-2">Phase 3: Autonomous Replication (Overnight)</div>
                  <p className="text-muted-foreground text-sm">Let autonomous agents with fresh context replicate the pattern 10x. Each iteration maintains the quality of your original prototype.</p>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Fresh Context Requirements:</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">1.</span>
                  <div>
                    <strong className="text-foreground">Stateless Stories:</strong> Each story must be implementable without knowing the journey of previous stories
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">2.</span>
                  <div>
                    <strong className="text-foreground">Clear Dependencies:</strong> If Story B needs Story A, mark it explicitly. Don't rely on context to communicate this
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">3.</span>
                  <div>
                    <strong className="text-foreground">Pattern References:</strong> Point to existing code, not conversation history: "Follow UserForm.tsx" not "like we did before"
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">4.</span>
                  <div>
                    <strong className="text-foreground">Self-Contained Context:</strong> Each story includes all information needed to implement it
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-12 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">The Architecture</div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/compound-intelligence" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
