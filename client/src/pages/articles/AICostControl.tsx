      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 grid md:grid-cols-3 gap-6">
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-2 uppercase text-sm tracking-wider">Lever 1</div>
                <div className="text-foreground font-bold text-xl mb-3">Reduce Calls</div>
                <div className="text-muted-foreground text-sm">Don't call the model if you don't have to. Fetch existing results. Import artifacts. Avoid redundant operations.</div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-2 uppercase text-sm tracking-wider">Lever 2</div>
                <div className="text-foreground font-bold text-xl mb-3">Reduce Tokens</div>
                <div className="text-muted-foreground text-sm">Keep prompts small. Pass references, not full text. Summarize once, then reuse the summary.</div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-2 uppercase text-sm tracking-wider">Lever 3</div>
                <div className="text-foreground font-bold text-xl mb-3">Reduce Waste</div>
                <div className="text-muted-foreground text-sm">Store outputs durably. Make them readable. Enable reuse. If you can't reuse, you'll pay forever.</div>
              </div>
            </div>
            ...
            <div className="my-10 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Per-Run Budget System</div>
              <div className="space-y-4 text-muted-foreground">
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold">Set caps:</span>
                  <span>"This workflow can spend at most X units" / "This step can spend at most Y units"</span>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold">On exceed:</span>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Cache These</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Deterministic transforms (normalization, parsing)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Stable inputs (summaries that rarely change)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Fetch-by-id results (external system is source of truth)</span>
                  </div>
                </div>
              </div>
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Be Careful With</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">!</span>
                    <span className="text-muted-foreground">User-private context (requires tenant/user isolation)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">!</span>
                    <span className="text-muted-foreground">Secrets or credentials (never cache these)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">!</span>
                    <span className="text-muted-foreground">Time-sensitive data (stale caches cause bugs)</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Cost Checklist */}
            <div className="my-10 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">AI Step Cost Checklist</div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-muted-foreground">Reliability reduces cost more than model switching</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Budget caps + import-first + caching is the practical trio</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Build recovery paths so cost control doesn't reduce velocity</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Most cost overruns come from retries and rework, not expensive calls</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/quality-gates-for-ai" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
