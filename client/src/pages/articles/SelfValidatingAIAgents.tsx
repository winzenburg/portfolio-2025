        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Implement the Story</div>
                    <p className="text-muted-foreground text-sm">Agent reads acceptance criteria and writes code to satisfy them.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Generate Validation Tests</div>
                    <p className="text-muted-foreground text-sm">Agent converts each acceptance criterion into a testable check.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Run Validation</div>
                    <p className="text-muted-foreground text-sm">Execute tests and collect results: pass/fail for each criterion.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Self-Correct or Commit</div>
                    <p className="text-muted-foreground text-sm">If all criteria pass → commit. If failures exist → analyze, fix, return to step 3.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">Examples of Programmatically Testable Criteria:</div>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">Examples of Structurally Testable Criteria:</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">✓</span>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">Examples of Visually Testable Criteria:</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">✓</span>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Examples of Manually Testable Criteria:</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-8">
              <div className="text-primary font-semibold mb-4">Story: Add Priority Filter Dropdown</div>
              
              <div className="mb-6">
                <div className="text-foreground font-semibold mb-3">Acceptance Criteria (All Testable):</div>
              ...
              <div className="border-t border-border pt-6">
                <div className="text-foreground font-semibold mb-3">Agent's Self-Validation Process:</div>
                <div className="space-y-4">
                  <div className="bg-muted/50 border border-border rounded p-4">
                    <div className="text-primary text-sm mb-2">Test 1: Component Existence</div>
                    <code className="text-xs text-muted-foreground">assert(exists('src/pages/TaskList.tsx'))</code>
                    <div className="text-green-700 text-xs mt-1">✓ PASS</div>
                  </div>

                  <div className="bg-muted/50 border border-border rounded p-4">
                    <div className="text-primary text-sm mb-2">Test 2: Dropdown Options</div>
                    <code className="text-xs text-muted-foreground">assert(dropdown.options === ["All", "High", "Medium", "Low", "None"])</code>
                    <div className="text-green-700 text-xs mt-1">✓ PASS</div>
                  </div>

                  <div className="bg-muted/50 border border-border rounded p-4">
                    <div className="text-primary text-sm mb-2">Test 3: Filter Logic</div>
                    <code className="text-xs text-muted-foreground">assert(filterTasks(tasks, "high").every(t =&gt; t.priority === "high"))</code>
                    <div className="text-green-700 text-xs mt-1">✓ PASS</div>
                  </div>

                  <div className="bg-muted/50 border border-border rounded p-4">
                    <div className="text-primary text-sm mb-2">Test 4: URL State Persistence</div>
                    <code className="text-xs text-muted-foreground">assert(window.location.search === "?priority=high")</code>
                    <div className="text-green-700 text-xs mt-1">✓ PASS</div>
                  </div>

                  <div className="bg-muted/50 border border-border rounded p-4">
                    <div className="text-primary text-sm mb-2">Test 5: Design System Usage</div>
                    <code className="text-xs text-muted-foreground">assert(imports.includes("@/components/ui/Select"))</code>
                    <div className="text-green-700 text-xs mt-1">✓ PASS</div>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-border pt-4 mt-4">
                <div className="text-foreground font-semibold">Result: All 5 criteria passed → Code committed automatically</div>
              </div>
            </div>
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-8">
              <div className="text-foreground font-semibold mb-4">Real Failure → Self-Correction Example</div>
              
              <div className="space-y-4">
                <div className="bg-destructive/10 border border-destructive/30 rounded p-4">
                  <div className="text-destructive text-sm mb-2">Iteration 1: Initial Implementation</div>
                  <p className="text-muted-foreground text-xs mb-2">Agent implemented filter logic but forgot URL state persistence</p>
                  <div className="text-destructive text-xs">✗ Test 4 FAILED: URL not updating</div>
                </div>

                <div className="bg-cyan-900/10 border border-primary/15 rounded p-4">
                  <div className="text-primary text-sm mb-2">Iteration 2: Self-Correction</div>
                  <p className="text-muted-foreground text-xs mb-2">Agent analyzed failure, added URL state sync with useSearchParams</p>
                  <div className="text-green-700 text-xs">✓ All tests PASSED</div>
                </div>
              </div>

              <div className="mt-4 pt-4 border-t border-border">
                <p className="text-muted-foreground text-sm"><strong className="text-foreground">Cost of self-correction:</strong> $6 (two iterations vs manual debugging)</p>
                <p className="text-muted-foreground text-sm mt-2"><strong className="text-foreground">Time saved:</strong> 20+ minutes of manual testing and debugging</p>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="space-y-6">
                <div>
                  <div className="text-primary font-semibold mb-2">1. Binary Pass/Fail</div>
                  <p className="text-muted-foreground text-sm mb-2">Each criterion must have exactly two possible outcomes: it passes or it fails. No "partially correct."</p>
                  <div className="grid md:grid-cols-2 gap-4 mt-3">
                    <div className="bg-destructive/10 border border-destructive/30 rounded p-3">
                      <div className="text-destructive text-xs mb-1">❌ Not Binary:</div>
                      <p className="text-muted-foreground text-xs">"Dropdown should look reasonable"</p>
                    </div>
                    <div className="bg-cyan-900/10 border border-primary/15 rounded p-3">
                      <div className="text-primary text-xs mb-1">✓ Binary:</div>
                      <p className="text-muted-foreground text-xs">"Dropdown uses className 'w-48 h-10 border rounded'"</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div className="text-primary font-semibold mb-2">2. Independently Testable</div>
                  <p className="text-muted-foreground text-sm mb-2">Each criterion can be tested without depending on other criteria passing first.</p>
                  <div className="grid md:grid-cols-2 gap-4 mt-3">
                    <div className="bg-destructive/10 border border-destructive/30 rounded p-3">
                      <div className="text-destructive text-xs mb-1">❌ Dependent:</div>
                      <p className="text-muted-foreground text-xs">"After previous steps work, save button appears"</p>
                    </div>
                    <div className="bg-cyan-900/10 border border-primary/15 rounded p-3">
                      <div className="text-primary text-xs mb-1">✓ Independent:</div>
                      <p className="text-muted-foreground text-xs">"Save button exists with id='save-btn'"</p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div className="text-primary font-semibold mb-2">3. Assertion-Friendly</div>
                  <p className="text-muted-foreground text-sm mb-2">Criteria should translate naturally to code assertions or test expectations.</p>
                  <div className="grid md:grid-cols-2 gap-4 mt-3">
                    <div className="bg-destructive/10 border border-destructive/30 rounded p-3">
                      <div className="text-destructive text-xs mb-1">❌ Hard to Assert:</div>
                      <p className="text-muted-foreground text-xs">"Page loads fast"</p>
                    </div>
                    <div className="bg-cyan-900/10 border border-primary/15 rounded p-3">
                      <div className="text-primary text-xs mb-1">✓ Assertion-Friendly:</div>
                      <p className="text-muted-foreground text-xs">"Page load time {"<"} 2 seconds (Lighthouse score)"</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/50 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4">Without Self-Validation</div>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Build iterations:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Your testing time:</span>
                  ...
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Manual fixes:</span>
                  ...
                  <div className="flex justify-between font-bold">
                    ...
                    <span className="text-destructive">105 min</span>
                  </div>
                </div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4">With Self-Validation</div>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">Build iterations:</span>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">Time Savings</div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-foreground">UX Quality:</strong> Agents can verify a button exists, not whether its placement feels right</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">✗</span>
                  <span><strong className="text-foreground">Edge Cases:</strong> Unusual input combinations that weren't specified in criteria</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">✗</span>
                  <span><strong className="text-foreground">Performance:</strong> Code might work but run slowly (unless you specify performance criteria)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">✗</span>
                  <span><strong className="text-foreground">Accessibility:</strong> Semantic HTML and ARIA labels (unless explicitly in criteria)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="my-12 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">The Pattern</div>
          ...
          <div className="bg-primary/8 border border-primary/20 rounded-lg p-8 my-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">Let's discuss how to structure your development process for autonomous success.</p>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/autonomous-ai-coding" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
