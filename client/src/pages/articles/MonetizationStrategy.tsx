          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-border rounded-lg p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-foreground mb-1">$100-200</div>
                  <div className="text-sm text-muted-foreground">Optimal price (10-20%)</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-700 mb-1">No-brainer</div>
                  <div className="text-sm text-muted-foreground">Customer decision</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-gradient-to-br from-blue-900/20 to-green-900/20 border border-border rounded-lg p-6">
                <div className="text-green-700 font-semibold mb-4 uppercase text-sm tracking-wider">What Works</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-green-700">✓</span>
                    <span className="text-muted-foreground">Annual plans (2 months free → 83% take annual)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-green-700">✓</span>
                    <span className="text-muted-foreground">Tiered pricing (most choose middle option)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-green-700">✓</span>
                    <span className="text-muted-foreground">Clear feature differentiation</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-green-700">✓</span>
                    <span className="text-muted-foreground">Remove vs. add framing ("Unlimited" not "No limits")</span>
                  </div>
                </div>
              </div>
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">What Doesn't Work</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Too many tiers (3-4 max)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Confusing feature matrices</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                  ...
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Unclear upgrade paths</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-muted/50 border-l-4 border-blue-500 p-4">
                <h4 className="text-foreground font-semibold mb-2">Step 1: Create Compelling Pre-Sale Offer</h4>
              ...
              <div className="bg-muted/50 border-l-4 border-blue-500 p-4">
                <h4 className="text-foreground font-semibold mb-2">Step 2: Build Landing Page</h4>
                <div className="text-muted-foreground text-sm space-y-1">
              ...
              <div className="bg-muted/50 border-l-4 border-blue-500 p-4">
                <h4 className="text-foreground font-semibold mb-2">Step 3: Drive Traffic</h4>
                <div className="text-muted-foreground text-sm space-y-1">
              ...
              <div className="bg-muted/50 border-l-4 border-blue-500 p-4">
                <h4 className="text-foreground font-semibold mb-2">Step 4: Deliver and Communicate</h4>
                <div className="text-muted-foreground text-sm space-y-1">
            ...
            <div className="my-10 grid md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-green-900/20 to-blue-900/20 border border-border rounded-lg p-6 text-center">
                <div className="text-3xl font-bold text-green-700 mb-2">50-100</div>
              ...
              <div className="bg-muted/50 border border-destructive/30 rounded-lg p-6 text-center">
                ...
                <div className="text-muted-foreground text-sm">Signals weak demand (pivot)</div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-green-700 font-semibold">70-90%</span>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-green-900/20 border border-border rounded-lg p-8">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-700 mb-1">$15K-50K</div>
                  <div className="text-sm text-muted-foreground">Month 3 MRR</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-700 mb-1">$30K-100K</div>
                  <div className="text-sm text-muted-foreground">Month 6 MRR</div>
                </div>
              </div>
            </div>
