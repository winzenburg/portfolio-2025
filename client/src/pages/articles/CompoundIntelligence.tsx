        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-4 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-foreground">Explicit Code:</strong> The implementation itself. What the system does.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">2.</span>
                  <div>
                    <strong className="text-foreground">Comments:</strong> Brief explanations of confusing sections.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">3.</span>
                  <div>
                    <strong className="text-foreground">READMEs:</strong> High-level setup and usage instructions.
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-8 bg-destructive/10 border border-destructive/30 rounded-lg p-6">
              <div className="text-destructive font-semibold mb-4">Missing Knowledge (Lost Every Build):</div>
...
`}
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-primary/20 border border-cyan-500 flex items-center justify-center text-primary font-bold">
                    1
                  </div>
                  <div>
                    <div className="text-foreground font-semibold mb-2">Agent Reads Context</div>
                    <p className="text-muted-foreground text-sm">Before implementing a story, agent reads `.ai/context.md` (or relevant module context files). Gets project-specific knowledge, known patterns, pitfalls to avoid.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Agent Implements Story</div>
                    <p className="text-muted-foreground text-sm">Builds the feature. Discovers edge cases. Learns what works and what doesn't. Encounters problems previous agents didn't document.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Agent Documents Learnings</div>
                    <p className="text-muted-foreground text-sm">After successful build, agent appends to context file: "Here's what I learned. Here's what to watch out for. Here's the pattern that worked."</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Next Agent Benefits</div>
                    <p className="text-muted-foreground text-sm">Future agents read updated context. They don't repeat mistakes. They build on previous learnings. Quality improves over time.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-8">
              <div className="space-y-6">
                <div className="bg-muted/50 border border-destructive/30 rounded p-4">
                  <div className="text-destructive font-semibold mb-2">Build 1: No Context File (Naive Implementation)</div>
                  <p className="text-muted-foreground text-sm mb-3">Agent implemented form validation with onChange validation. Users complained about aggressive error messages while typing.</p>
                  <div className="text-destructive text-xs">❌ Poor UX, required rework</div>
                </div>
                ...
                <div className="bg-muted/50 border border-cyan-900/30 rounded p-4">
                  <div className="text-primary font-semibold mb-2">Build 3: Compound Intelligence Working</div>
                  <p className="text-muted-foreground text-sm mb-2">Agent read updated context: validation pattern + async pitfall.</p>
                  <p className="text-muted-foreground text-sm mb-3">Implemented form correctly on first try. No UX issues. No race conditions.</p>
                  <p className="text-muted-foreground text-sm mb-2">Agent discovered: Form state persists across route changes if not cleared.</p>
                  <p className="text-muted-foreground text-sm mb-3">Agent documented: "Always implement cleanup in useEffect. Users navigating back see stale data otherwise."</p>
                  <div className="text-primary text-xs">✓ Perfect implementation + new learning documented</div>
                </div>
...
`}
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4">✓ Document These</div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">→</span>
                    <span className="text-muted-foreground">Approaches that failed and why</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">→</span>
                    <span className="text-muted-foreground">Non-obvious edge cases discovered</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">→</span>
                    <span className="text-muted-foreground">Performance gotchas and solutions</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">→</span>
                    <span className="text-muted-foreground">Patterns that worked well (with examples)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">→</span>
                    <span className="text-muted-foreground">Dependencies and their quirks</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">→</span>
                    <span className="text-muted-foreground">Testing requirements unique to this module</span>
                  </li>
                </ul>
              </div>
              <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4">✗ Skip These</div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">✗</span>
                    <span className="text-muted-foreground">What the code does (code itself shows this)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">✗</span>
                    <span className="text-muted-foreground">Basic usage examples (put in README)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">✗</span>
                    <span className="text-muted-foreground">Setup instructions (belongs in docs/)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">✗</span>
                    <span className="text-muted-foreground">Generic best practices (agents know these)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">✗</span>
                    <span className="text-muted-foreground">Changelog entries (use git history)</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Add to Story Acceptance Criteria:</div>
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">New developers onboard faster:</strong> Context files show gotchas upfront, not after weeks of mistakes
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Code reviews reference context:</strong> "This violates the pattern in .ai-context.md section 3"
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Decisions are traceable:</strong> "Why do we do it this way?" → Check context file
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Knowledge doesn't leave:</strong> When devs leave, their insights remain documented
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">Week 1: Foundation</div>
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">Weeks 2-4: Habit Formation</div>
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
            ...
            <div className="my-8 bg-primary/5 border border-primary/20 rounded-lg p-6">
              <div className="text-primary font-semibold mb-4">Month 2+: Scaling</div>
              <ul className="space-y-2 text-muted-foreground text-sm">
                <li className="flex items-start gap-3">
            ...
            <div className="my-12 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">The Compounding Effect</div>
          ...
          <div className="bg-primary/8 border border-primary/20 rounded-lg p-8 my-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">Let's discuss how to architect codebases that get smarter over time.</p>
