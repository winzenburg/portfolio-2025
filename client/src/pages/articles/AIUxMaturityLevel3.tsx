      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0">
            ...
            <div className="my-10 bg-muted/40 border border-border/50 rounded-lg p-6">
              <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-5">NNG UX Maturity Scale</h3>
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={row.level}
                    className={`flex items-start gap-4 rounded-lg px-4 py-3 ${row.active ? "bg-primary/5 border border-cyan-700/40" : "border border-transparent"}`}
                  >
                    <div className={`text-xs font-bold uppercase tracking-wider pt-0.5 w-16 shrink-0 ${row.active ? "text-primary" : row.dim ? "text-muted-foreground" : "text-muted-foreground"}`}>
                      {row.level}
                    </div>
                    <div>
                      <div className={`font-semibold text-sm mb-0.5 ${row.active ? "text-primary" : row.dim ? "text-muted-foreground" : "text-muted-foreground"}`}>{row.label}</div>
                      <div className={`text-sm leading-relaxed ${row.active ? "text-muted-foreground" : "text-muted-foreground"}`}>{row.desc}</div>
                    </div>
                    {row.active && (
                      <div className="ml-auto shrink-0 text-xs font-semibold text-primary bg-primary/8 border border-cyan-700/40 rounded-full px-3 py-1">
                        The real target
                      </div>
                    )}
                  </div>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-5">
              ...
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-5">
                <div className="text-destructive font-semibold text-sm uppercase tracking-wider mb-3">Low trust</div>
                <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <div className="my-8 bg-muted border border-primary/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-primary mb-5">Discovery that doesn't require a budget line</h3>
              <div className="space-y-6">
                <div>
                  <div className="text-foreground font-semibold mb-2">JTBD from existing data</div>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                <div>
                  <div className="text-foreground font-semibold mb-2">Competitive reads in an afternoon</div>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                <div>
                  <div className="text-foreground font-semibold mb-2">Continuous pain point extraction</div>
                  <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <div className="my-10 bg-muted/40 border border-border/50 rounded-lg p-6">
              <h3 className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-5">The full chain</h3>
              <div className="space-y-3">
                {[
              ...
              <p className="text-muted-foreground text-sm mt-5 pt-5 border-t border-border/50">
