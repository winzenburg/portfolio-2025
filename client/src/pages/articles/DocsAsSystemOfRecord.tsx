        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">What a System of Record Should Store</div>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Docs Succeed When...</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Human-readable (context is preserved)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Portable (easy to share and access)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Easy to link (creates knowledge graph)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Easy to diff and review (changes visible)</span>
                  </div>
                </div>
              </div>
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Docs Fail When...</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Naming is inconsistent</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Location is inconsistent</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Documents don't link to each other</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">No clear ownership or update cadence</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Naming Conventions */}
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Example Naming Prefixes</div>
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded">CHECKLIST-*</code>
                  <span className="text-muted-foreground">Recurring process steps</span>
                </div>
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded">RESULTS-*</code>
                  <span className="text-muted-foreground">Outputs and findings</span>
                </div>
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded">PLAN-*</code>
                  <span className="text-muted-foreground">Forward-looking intentions</span>
                </div>
                <div className="flex items-start gap-3">
                  <code className="text-primary bg-muted/50 px-2 py-1 rounded">DECISION-*</code>
                  <span className="text-muted-foreground">Choices with rationale</span>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Standard Document Set</div>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">1</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">One-page plan</div>
                    <div className="text-muted-foreground text-sm">What we're trying to accomplish and how</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">2</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Checklist for recurring work</div>
                    <div className="text-muted-foreground text-sm">The steps we'll follow repeatedly</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">3</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Results log</div>
                    <div className="text-muted-foreground text-sm">What happened, what was learned</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">4</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Decision note</div>
                    <div className="text-muted-foreground text-sm">What was decided and why</div>
                  </div>
                </div>
              </div>
              <div className="mt-6 pt-4 border-t border-border">
                <div className="text-muted-foreground text-sm">Then link them together so you can navigate the full story.</div>
              </div>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Systems fail when knowledge is scattered and un-auditable</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Docs as record works when naming, location, and links are consistent</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">The compounding effect comes from turning results into checklists and reusable templates</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Make docs part of definition of done, not a separate activity</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/maker-vs-manager" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
