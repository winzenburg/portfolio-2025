      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <ol className="text-muted-foreground leading-relaxed mb-6 space-y-2">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">No Tests == No Definition of "Done"</strong>: Without tests, "done" means "it worked when I tried it once." You're essentially shipping undefined behavior and hoping for the best.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Edge Cases Are Afterthoughts</strong>: Humans are notoriously bad at remembering edge cases when we're in the flow of building. "What if the project has 1,000 tasks?" "What if the user is a viewer, not an owner?" These questions only surface after the bugs do.
            </p>

            {/* Stats Card */}
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center mb-4">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">Edge Cases Caught</div>
                <div className="text-5xl font-bold text-primary mb-2">27</div>
                <div className="text-muted-foreground text-sm">During planning phase in the last 3 months</div>
                <div className="text-muted-foreground text-xs mt-2">vs. catching them in production (expensive and embarrassing)</div>
              </div>
            </div>

            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Tests Become Debt</strong>: If tests are optional, they never get written. There's always a new feature, a new deadline, a new fire to put out. Testing becomes "we should really do this someday" debt that compounds faster than credit card interest.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Manual Testing Doesn't Scale</strong>: Every new feature adds to the manual test matrix. Eventually, QA becomes a bottleneck and teams start cutting corners. I've been there, it's not pretty.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Here's what we changed: We treat the dev quality plan the same way we treat the PRD, <strong className="text-foreground">it's a mandatory deliverable before implementation starts</strong>.
            </p>
            ...
            <ol className="text-muted-foreground leading-relaxed mb-6 space-y-2">
              <li><strong className="text-foreground">Product Spec (PRD/ADR)</strong> → What we're building and why</li>
              <li><strong className="text-primary">Dev Quality Plan</strong> ← NEW GATE (what tests, quality checks, deploy steps)</li>
              <li><strong className="text-foreground">Implementation</strong> → Write code guided by the test plan</li>
              <li><strong className="text-foreground">Quality Checks</strong> → Run lint, tests, deploy checklist</li>
              <li><strong className="text-foreground">Ship</strong> (with actual confidence this time)</li>
            </ol>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Our dev quality plan (we call it Rule 125, template at <code className="text-primary bg-muted px-2 py-1 rounded">docs/templates/DEV-QUALITY-TEMPLATE.md</code>) has four sections that we never skip:
            </p>

            <h4 className="text-xl font-bold text-foreground mt-6 mb-3">1. Feature Snapshot</h4>
            ...
            <h4 className="text-xl font-bold text-foreground mt-6 mb-3">2. Automated Test Suggestions (The Meat and Potatoes)</h4>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Functional Tests (The Happy Path)</strong>:
            </p>
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Edge Case Tests (The Unhappy Path)</strong>:
            </p>
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Regression / Non-Functional Tests</strong>:
            </p>
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <h5 className="text-foreground font-semibold mb-4">Real Example: "Archive Project" Feature</h5>
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border">
                      <th className="text-left py-2 text-primary">Test</th>
                      <th className="text-left py-2 text-primary">Purpose</th>
                      <th className="text-left py-2 text-primary">Type</th>
                      <th className="text-left py-2 text-primary">Where</th>
                    </tr>
                  </thead>
                  <tbody className="text-muted-foreground">
                    <tr className="border-b border-border">
                      ...
                      <td className="py-2 text-primary">`projects.test.ts`</td>
                    </tr>
                    <tr className="border-b border-border">
                      ...
                      <td className="py-2 text-primary">`project-list.test.tsx`</td>
                    </tr>
                    <tr className="border-b border-border">
                      <td className="py-2">Archiving requires owner/admin role</td>
                      <td className="py-2">Verify permissions</td>
                      <td className="py-2">Integration</td>
                      <td className="py-2 text-primary">`api/archive.test.ts`</td>
                    </tr>
                    <tr>
                      ...
                      <td className="py-2 text-primary">`e2e/archive.spec.ts`</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <h4 className="text-xl font-bold text-foreground mt-6 mb-3">3. Code Quality & Lint Guidance</h4>
            ...
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
              <li><strong className="text-foreground">State management</strong>: How should state be handled? (Context, Zustand, server state)</li>
              <li><strong className="text-foreground">Data fetching</strong>: Use tRPC, React Query, or plain fetch?</li>
              <li><strong className="text-foreground">Security</strong>: What auth checks are required?</li>
              <li><strong className="text-foreground">Accessibility</strong>: Any ARIA labels, keyboard shortcuts, focus management?</li>
              <li><strong className="text-foreground">Error handling</strong>: How should errors be displayed? Logged?</li>
            </ul>
            ...
            <h4 className="text-xl font-bold text-foreground mt-6 mb-3">4. Deployment Confidence Checklist</h4>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Pre-Push</strong>:
            </p>
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
              <li>All tests pass (<code className="text-primary bg-muted px-2 py-1 rounded">npm test</code>)</li>
              <li>No TypeScript errors (<code className="text-primary bg-muted px-2 py-1 rounded">npm run type-check</code>)</li>
              <li>Linting passes (<code className="text-primary bg-muted px-2 py-1 rounded">npm run lint</code>)</li>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Post-Deploy</strong>:
            </p>
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Rollback Plan</strong>:
            </p>
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Here's the critical part: <strong className="text-foreground">the dev quality plan is a hard blocker</strong>.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-6">
              In <code className="text-primary bg-muted px-2 py-1 rounded">000-orchestration.mdc</code> (our central foreman), we added:
            </p>

            <div className="my-8 bg-muted border border-border rounded-lg p-6">
...
- Before deploying: Deployment checklist must be completed`}
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Context</strong>: We needed to add the ability for organization owners to invite new members via email. Sounds simple, right? (Famous last words...)
            </p>
            ...
            <div className="my-8 bg-muted/30 border-l-4 border-primary px-6 pt-4 pb-5">
              <h5 className="text-foreground font-semibold mb-4">Feature Snapshot</h5>
              <p className="text-muted-foreground mb-4"><strong className="text-foreground">Description</strong>: Organization owners and admins can invite new members via email. Invites are sent via Resend, stored in `org_invites` table, and can be accepted via magic link.</p>
              
              <p className="text-muted-foreground mb-2"><strong className="text-foreground">Affected surfaces</strong>:</p>
              <ul className="text-muted-foreground text-sm space-y-1 mb-4">
                <li>New API route: <code className="text-primary bg-muted px-2 py-1 rounded">POST /api/orgs/&#123;id&#125;/invites</code></li>
                <li>New database table: <code className="text-primary bg-muted px-2 py-1 rounded">org_invites</code></li>
                <li>New email template: <code className="text-primary bg-muted px-2 py-1 rounded">invite-email.tsx</code></li>
                <li>UI: New "Invite Member" modal in org settings</li>
              </ul>

              <p className="text-muted-foreground"><strong className="text-foreground">Owners</strong>: @engineeringArchitect, @implementer, @testEngineer</p>
            </div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Functional Tests</strong>:
            </p>
            <ol className="text-muted-foreground leading-relaxed mb-6 space-y-1">
              <li><strong className="text-foreground">Owner can send invite</strong> → Integration → <code className="text-primary bg-muted px-2 py-1 rounded">api/invites.test.ts</code></li>
              <li><strong className="text-foreground">Invite email is sent via Resend</strong> → Integration → <code className="text-primary bg-muted px-2 py-1 rounded">api/invites.test.ts</code> (mock Resend)</li>
              <li><strong className="text-foreground">Invite token is valid for 7 days</strong> → Unit → <code className="text-primary bg-muted px-2 py-1 rounded">invites.test.ts</code></li>
              <li><strong className="text-foreground">Accepting invite adds user to org</strong> → E2E → <code className="text-primary bg-muted px-2 py-1 rounded">e2e/invites.spec.ts</code></li>
              <li><strong className="text-foreground">User sees new org in org switcher</strong> → E2E → <code className="text-primary bg-muted px-2 py-1 rounded">e2e/invites.spec.ts</code></li>
            </ol>

            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Edge Case Tests</strong> (this is where we catch the expensive bugs):
            </p>
            <ol className="text-muted-foreground leading-relaxed mb-6 space-y-1">
              <li><strong className="text-foreground">Non-owner cannot send invite</strong> → Returns 403 → Integration → <code className="text-primary bg-muted px-2 py-1 rounded">api/invites.test.ts</code></li>
              <li><strong className="text-foreground">Inviting existing member returns error</strong> → Integration → <code className="text-primary bg-muted px-2 py-1 rounded">api/invites.test.ts</code></li>
              <li><strong className="text-foreground">Expired invite token returns error</strong> → Unit → <code className="text-primary bg-muted px-2 py-1 rounded">invites.test.ts</code></li>
              <li><strong className="text-foreground">Malformed email returns 400</strong> → Integration → <code className="text-primary bg-muted px-2 py-1 rounded">api/invites.test.ts</code></li>
              <li><strong className="text-foreground">User already in 5 orgs (limit) cannot accept</strong> → E2E → <code className="text-primary bg-muted px-2 py-1 rounded">e2e/invites.spec.ts</code></li>
              <li><strong className="text-foreground">Invite to non-existent org returns 404</strong> → Integration → <code className="text-primary bg-muted px-2 py-1 rounded">api/invites.test.ts</code></li>
            </ol>

            {/* Comparison Card */}
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-2 uppercase text-sm tracking-wider">Without Planning</div>
                <div className="text-muted-foreground text-sm">These 6 edge cases would've been production bugs discovered by users</div>
              </div>
              <div className="bg-primary/8 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-2 uppercase text-sm tracking-wider">With Planning</div>
                <div className="text-muted-foreground text-sm font-semibold">Caught during implementation, fixed before shipping</div>
              </div>
            </div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Total time to create the dev quality plan: <strong className="text-foreground">45 minutes</strong>.
            </p>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center mb-4">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">Time Saved Per Feature</div>
                <div className="text-5xl font-bold text-primary mb-2">~10 hours</div>
                <div className="text-muted-foreground text-sm">45 minutes of planning saves 10+ hours of debugging and rework</div>
              </div>
            </div>

            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">ROI: 45 minutes of planning saved ~10 hours of debugging and rework.</strong>
            </p>
            ...
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
              <li><strong className="text-foreground">Test Engineer</strong> (if you have one)</li>
              <li><strong className="text-foreground">Dev Quality Assistant</strong> (an AI agent guided by the template)</li>
              <li><strong className="text-foreground">Tech Lead</strong> (for complex features)</li>
              <li><strong className="text-foreground">Implementer</strong> (for simple features)</li>
            </ul>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Impact on velocity</strong>:
            </p>
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Net result</strong>: ~10-12 hours saved per feature, plus higher quality and way fewer 3am "production is down" Slack messages.
            </p>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Upfront Time Investment</strong>: 30-60 minutes per feature to create the plan. For small features (one-line changes), this can feel like overkill.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Requires Testing Knowledge</strong>: Not everyone knows how to design good tests. Junior engineers might struggle to map acceptance criteria to test cases. You need training or an experienced Test Engineer to guide.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Can Create Rigidity</strong>: If the plan is too detailed, it constrains implementation choices. You need to balance guidance with flexibility.
            </p>

            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">Doesn't Catch Everything</strong>: The plan only covers what you think to test. Novel bugs or edge cases you didn't anticipate still slip through. You still need exploratory testing and user feedback.
            </p>
            ...
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
              <li><strong className="text-foreground">Prototypes / spikes</strong> (not production-ready)</li>
              <li><strong className="text-foreground">Trivial changes</strong> (copy updates, styling tweaks)</li>
              <li><strong className="text-foreground">Internal tools</strong> (lower quality bar)</li>
              <li><strong className="text-foreground">Reversible experiments</strong> (easy to rollback)</li>
            </ul>
            ...
            <ul className="text-muted-foreground leading-relaxed mb-6 space-y-1">
              <li><strong className="text-foreground">AI-generated plans</strong>: Using Claude to auto-generate test suggestions from PRDs</li>
              <li><strong className="text-foreground">Test coverage tracking</strong>: Dashboards showing which features have full vs. partial coverage</li>
              <li><strong className="text-foreground">Quality scores</strong>: Numeric scoring for test completeness, lint compliance, deployment readiness</li>
            </ul>
