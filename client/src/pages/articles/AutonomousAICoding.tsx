      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="mb-12 rounded-lg overflow-hidden">
            <img
              src="/images/articles/autonomous-ai-coding-hero.webp"
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-foreground">Discovery:</strong> 10 hours to find and validate a real problem</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-muted-foreground mt-1">→</span>
                  <span><strong className="text-foreground">PRD:</strong> 5 hours to define what to build</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">→</span>
                  <span><strong className="text-foreground">Implementation:</strong> 40+ hours of actual coding ← THE BOTTLENECK</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-muted-foreground mt-1">→</span>
                  <span><strong className="text-foreground">Launch:</strong> 2 hours to deploy and monitor</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4 mb-8">
              <div className="bg-muted/50 border-l-4 border-primary p-4">
                <div className="text-foreground font-semibold mb-2">Phase 1: Write the PRD (30-60 minutes)</div>
                <p className="text-muted-foreground text-sm">Break the feature into 5-15 atomic user stories. Each story must have 3-5 specific, testable acceptance criteria. This is where 80% of success is determined.</p>
              </div>

              <div className="bg-muted/50 border-l-4 border-primary p-4">
                <div className="text-foreground font-semibold mb-2">Phase 2: Convert to Structured Format (5-10 minutes)</div>
                <p className="text-muted-foreground text-sm">Transform your PRD into a machine-readable format (JSON, YAML, or structured markdown). Define dependencies between stories. Add technical hints pointing to similar code.</p>
              </div>

              <div className="bg-muted/50 border-l-4 border-primary p-4">
                <div className="text-foreground font-semibold mb-2">Phase 3: Run Autonomous Build (2-8 hours, unattended)</div>
                <p className="text-muted-foreground text-sm">The agent pulls stories sequentially, implements each one in a fresh context, tests against acceptance criteria, and commits successful changes. You can monitor progress or go to sleep.</p>
              </div>

              <div className="bg-muted/50 border-l-4 border-primary p-4">
                <div className="text-foreground font-semibold mb-2">Phase 4: Test & Polish (30-60 minutes)</div>
                <p className="text-muted-foreground text-sm">Autonomous agents typically achieve 90-95% correctness. Spend time testing edge cases, improving error messages, and polishing the UX. Then ship.</p>
              </div>
            </div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Manual Approach</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">•</span>
                    <span className="text-muted-foreground"><strong className="text-foreground">Time:</strong> ~13 hours (PRD + coding + testing)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">•</span>
                    <span className="text-muted-foreground"><strong className="text-foreground">Cost:</strong> $1,300 @ $100/hour</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">•</span>
                    <span className="text-muted-foreground"><strong className="text-foreground">Attention:</strong> 100% active time</span>
                  </div>
                </div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Autonomous Approach</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground"><strong className="text-foreground">Time:</strong> 65 minutes active (PRD + testing)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground"><strong className="text-foreground">Cost:</strong> $42 in API usage</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground"><strong className="text-foreground">Attention:</strong> ~10% active time</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-4 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Requirements are crystal clear</strong>
                    <p className="text-muted-foreground text-sm mt-1">You have a detailed PRD with specific acceptance criteria. No ambiguity about what "done" looks like.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Stories are properly sized</strong>
                    <p className="text-muted-foreground text-sm mt-1">Each story can be completed in one context window (typically 1-3 files, under 50 lines of changes).</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">Patterns exist in the codebase</strong>
                    <p className="text-muted-foreground text-sm mt-1">The feature follows established architectural patterns. You can point to similar code as examples.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">You want parallel execution</strong>
                    <p className="text-muted-foreground text-sm mt-1">You can work on other things (or sleep) while the feature builds. Time arbitrage matters.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <div>
                    <strong className="text-foreground">90-95% is good enough initially</strong>
                    <p className="text-muted-foreground text-sm mt-1">You're willing to spend 20-60 minutes polishing edge cases after the autonomous build completes.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-8 bg-destructive/10 border border-destructive/30 rounded-lg p-6">
              <ul className="space-y-4 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">✗</span>
                  <div>
                    <strong className="text-foreground">Requirements are exploratory</strong>
                    <p className="text-muted-foreground text-sm mt-1">You're still figuring out what to build. Use interactive mode to explore and prototype.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">✗</span>
                  <div>
                    <strong className="text-foreground">High-risk changes</strong>
                    <p className="text-muted-foreground text-sm mt-1">Authentication, payments, security-critical code. Keep humans in the loop for these.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">✗</span>
                  <div>
                    <strong className="text-foreground">Novel architecture required</strong>
                    <p className="text-muted-foreground text-sm mt-1">The feature requires inventing new patterns. Agents guess poorly without examples.</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive mt-1">✗</span>
                  <div>
                    <strong className="text-foreground">Unfamiliar codebase</strong>
                    <p className="text-muted-foreground text-sm mt-1">First time working with the code? Learn it interactively before going autonomous.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4">❌ Bad Acceptance Criteria</div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">✗</span>
                    <span className="text-muted-foreground">"Add priority filtering" (too vague)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">✗</span>
                    <span className="text-muted-foreground">"Make it look good" (subjective)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-destructive mt-1">✗</span>
                    <span className="text-muted-foreground">"Implement the design" (requires external reference)</span>
                  </li>
                </ul>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4">✓ Good Acceptance Criteria</div>
                <ul className="space-y-3 text-sm">
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">✓</span>
                    <span className="text-muted-foreground">"Dropdown has exactly 5 options: All, High, Medium, Low, None"</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">✓</span>
                    <span className="text-muted-foreground">"Card component uses design system Card with shadow-sm and p-4"</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-primary mt-1">✓</span>
                    <span className="text-muted-foreground">"Layout matches AccountSettings page structure (see src/pages/AccountSettings.tsx)"</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="my-10 bg-muted/50 border border-border rounded-lg p-8">
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-foreground font-semibold mb-2">Dependencies must be explicit</div>
                    <div className="text-muted-foreground text-sm">If Story B needs Story A's database schema, mark it. Agents won't infer dependencies reliably.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">4</span>
                  <div>
                    <div className="text-foreground font-semibold mb-2">Expect to polish edge cases</div>
                    <div className="text-muted-foreground text-sm">Autonomous builds nail the happy path. Loading states, error messages, empty states, budget 20-60 minutes to add these yourself.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">5</span>
                  <div>
                    <div className="text-foreground font-semibold mb-2">Cost scales with complexity, not size</div>
                    <div className="text-muted-foreground text-sm">A 10-story CRUD feature might cost $30. A 3-story feature with novel architecture might cost $50. Complexity drives retries, which drive cost.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-primary/8 border border-primary/20 rounded-lg p-8 my-12 text-center">
            ...
            <p className="text-muted-foreground mb-6">Let's discuss how autonomous AI coding can transform your product development workflow.</p>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/ai-coding-economics" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
