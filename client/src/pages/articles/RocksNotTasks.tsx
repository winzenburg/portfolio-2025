      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Not a Rock</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">"Work on onboarding"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">"Fix bugs"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">"Improve performance"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">"Research competitors"</span>
                  </div>
                </div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">A Rock</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Ship single-step onboarding with one CTA + empty state"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Fix 3 bugs blocking primary action + add regression tests"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Reduce page load from 2.8s → 1.8s on top 3 routes"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Document 5 competitor pricing models with feature comparison"</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">"Done Looks Like" Examples</div>
              <div className="space-y-4 text-muted-foreground">
                <div>
                  <span className="text-primary font-semibold">Onboarding:</span> "Done looks like: new users can complete the first action in under 60 seconds."
                </div>
                <div>
                  <span className="text-primary font-semibold">Error handling:</span> "Done looks like: error state includes recovery copy and logs a structured error event."
                </div>
                <div>
                  <span className="text-primary font-semibold">Conversion:</span> "Done looks like: conversion rate improves from 4% → 6% over 7 days."
                </div>
                <div>
                  <span className="text-primary font-semibold">Documentation:</span> "Done looks like: API reference covers all public endpoints with examples."
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-destructive/10 border border-destructive/30 rounded-lg p-8">
              <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">What Happens With 4+ Rocks</div>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">1</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Partial completion</div>
                    <div className="text-muted-foreground text-sm">Everything gets touched, nothing gets finished. Progress is scattered across many half-done items.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">2</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Context switching</div>
                    <div className="text-muted-foreground text-sm">Jumping between many outcomes destroys deep work and increases cognitive load.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">3</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">"Busy week, nothing finished"</div>
                    <div className="text-muted-foreground text-sm">The calendar was full. The team worked hard. But nothing actually shipped.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">The Rock Filter</div>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">1</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Moves the focus metric</div>
                    <div className="text-muted-foreground text-sm">Is there a direct line between this outcome and the number you're trying to move?</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">2</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Unblocks other work</div>
                    <div className="text-muted-foreground text-sm">Does completing this enable something else that matters?</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-primary font-bold text-xl">3</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Finishable in one week</div>
                    <div className="text-muted-foreground text-sm">Can this actually be done with the time available? If not, split it.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Fake Rocks (Multi-week projects)</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">"Refactor onboarding"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">"Launch the new pipeline"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">"Rebuild the dashboard"</span>
                  </div>
                </div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Real Rocks (One-week outcomes)</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Extract onboarding step component + add one test"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Ship Step 1 with in-progress status + retry button"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">"Add one new card state, wire to real data"</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Rock Template */}
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Rock Template</div>
              <div className="space-y-4 text-muted-foreground font-mono text-sm">
                <div><span className="text-primary">Rock:</span> [What will exist by Friday]</div>
                <div><span className="text-primary">Why it matters:</span> [Which metric it moves]</div>
                <div><span className="text-primary">Done looks like:</span> [Verifiable end state]</div>
                <div><span className="text-primary">Risk/unknown:</span> [What could block this]</div>
                <div><span className="text-primary">Smallest test:</span> [How to reduce risk early]</div>
              </div>
            </div>
            ...
            {/* Takeaways Card */}
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Key Takeaways</div>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Task lists create motion; Rocks create outcomes</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Limit commitments to 1-3 weekly outcomes</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Every Rock needs "done looks like"</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Tie Rocks to the focus metric to prevent random work</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Split big Rocks until they're finishable in one week</span>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            <p className="text-muted-foreground mb-4">Next in This Series</p>
            <Link href="/articles/docs-as-system-of-record" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
