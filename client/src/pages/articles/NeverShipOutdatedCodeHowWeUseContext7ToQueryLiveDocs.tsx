      ...
      <article className="pt-10 pb-16 md:pt-14">
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              <strong className="text-foreground">The problem?</strong> Claude's training data was from Tailwind v3. I was using Tailwind v4. Half the API had changed.
            </p>
            ...
            <div className="my-8 bg-destructive/10 border border-destructive/30 rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-foreground">January 2024:</strong> Tailwind v4 beta released with breaking changes</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive">•</span>
                  <span><strong className="text-foreground">March 2024:</strong> Tailwind v4 stable released</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive">•</span>
                  <span><strong className="text-foreground">September 2024:</strong> Claude training cutoff (still knows v3)</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive">•</span>
                  <span><strong className="text-foreground">December 2024:</strong> You ask Claude for Tailwind code</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-destructive">•</span>
                  <span><strong className="text-foreground">Claude's response:</strong> Suggests v3 patterns (6-9 months outdated)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="my-10 bg-destructive/10 border border-destructive/30 rounded-lg p-8">
              <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">The Debugging Tax</div>
            ...
            <div className="my-10 grid md:grid-cols-2 gap-6">
              <div className="bg-destructive/10 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Traditional AI Workflow</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive font-bold">You:</span>
                    <span className="text-muted-foreground">"Generate Tailwind config for dark mode"</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive font-bold">AI:</span>
                    <span className="text-muted-foreground">[Uses training data from 6 months ago]</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive font-bold">AI:</span>
                    <span className="text-muted-foreground">[Suggests outdated v3 pattern]</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive font-bold">You:</span>
                    <span className="text-muted-foreground">[Debug for 1 hour]</span>
                  </div>
                </div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">Context7 MCP Workflow</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                  ...
                  <div className="flex items-start gap-2">
                    <span className="text-primary font-bold">Context7:</span>
                    <span className="text-muted-foreground">[Fetches latest Tailwind v4 docs]</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary font-bold">AI:</span>
                    <span className="text-muted-foreground">[Reads current docs]</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary font-bold">AI:</span>
                    <span className="text-muted-foreground">[Suggests current v4 pattern]</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary font-bold">You:</span>
                    <span className="text-muted-foreground font-semibold">[Works first try]</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted/50 border border-border rounded-lg p-6">
              <div className="text-muted-foreground text-sm mb-2">Outdated syntax (Supabase ~6 months ago)</div>
  ...
  USING (
    organization_id IN (
      ...
      WHERE user_id = current_user_id()
            ...
            <div className="my-8 bg-destructive/20 border border-destructive/30 rounded-lg p-6">
              <pre className="text-destructive overflow-x-auto">
...
Users should only see projects for organizations they're members of.`}
            ...
            <div className="my-8 bg-muted/50 border border-border rounded-lg p-6">
              <div className="text-muted-foreground text-sm mb-2">Current syntax (from Context7 docs)</div>
              <pre className="text-muted-foreground overflow-x-auto">
{`CREATE POLICY "Users see own org projects"
  ON projects
  FOR SELECT
      ...
      WHERE user_id = auth.uid()
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">Time Saved</div>
                <div className="text-3xl font-bold text-foreground">40 minutes</div>
                <div className="text-muted-foreground mt-2">5 minutes with Context7 vs. 45 minutes debugging</div>
              </div>
            </div>
            ...
            <div className="space-y-6 my-8">
              <div className="bg-muted/30 border border-border rounded-lg p-6">
                <h3 className="text-xl font-bold text-primary mb-3">1. Tailwind CSS v4</h3>
                <p className="text-muted-foreground mb-2">
                  <strong className="text-foreground">Why:</strong> Major breaking changes from v3. Config structure, plugin API, and imports all changed.
                </p>
                <p className="text-muted-foreground">
                  <strong className="text-foreground">What we query:</strong> Config file structure, plugin API, dark mode setup, custom utilities.
                </p>
              </div>

              <div className="bg-muted/30 border border-border rounded-lg p-6">
                <h3 className="text-xl font-bold text-primary mb-3">2. Next.js 15 (App Router)</h3>
                <p className="text-muted-foreground mb-2">
                  <strong className="text-foreground">Why:</strong> App Router patterns evolve rapidly. The metadata API changes every few months.
                </p>
                <p className="text-muted-foreground">
                  <strong className="text-foreground">What we query:</strong> API, server vs. client component patterns, route handlers, caching behavior.
                </p>
              </div>

              <div className="bg-muted/30 border border-border rounded-lg p-6">
                <h3 className="text-xl font-bold text-primary mb-3">3. Supabase (Auth, RLS, Edge Functions)</h3>
                <p className="text-muted-foreground mb-2">
                  <strong className="text-foreground">Why:</strong> Supabase updates frequently. Auth API, RLS syntax, Edge Functions, all moving targets.
                </p>
                <p className="text-muted-foreground">
                  <strong className="text-foreground">What we query:</strong> RLS policy syntax, auth patterns, Edge Functions, storage API.
                </p>
              </div>
            </div>
            ...
            <div className="my-12 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center mb-6">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">Our Context7 Results</div>
              </div>
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
                <div>
                  <div className="text-3xl font-bold text-primary mb-1">12-18 hours</div>
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">deprecated API warnings</div>
                </div>
                <div>
                  <div className="text-3xl font-bold text-primary mb-1">$2,400-3,600</div>
                  <div className="text-sm text-muted-foreground">monthly value at $200/hr</div>
                </div>
                <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              <strong className="text-foreground">Tools with MCP support:</strong>
            </p>

            <div className="my-6 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
            ...
            <div className="my-8 bg-muted/30 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span><strong className="text-foreground">Stable libraries:</strong> React core APIs, lodash, these don't change</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-muted-foreground">→</span>
                  <span><strong className="text-foreground">Business logic:</strong> Your app's specific code doesn't need external docs</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-muted-foreground">→</span>
                  <span><strong className="text-foreground">Quick prototypes:</strong> If you're just testing an idea, maybe don't worry about perfect API usage</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-muted-foreground">→</span>
                  <span><strong className="text-foreground">Libraries you know well:</strong> If you already understand the current API, Context7 adds overhead</span>
                </li>
              </ul>
            </div>
