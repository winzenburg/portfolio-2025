          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0">
            ...
            <div className="my-12 grid md:grid-cols-2 gap-6">
              <div className="bg-muted/30 border border-destructive/30 rounded-lg p-6">
                <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Bolt-on AI</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">10-30% faster on individual tasks</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Same handoffs, silos, and friction</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-destructive">✗</span>
                    <span className="text-muted-foreground">Process stays structurally unchanged</span>
                  </div>
                </div>
              </div>
              <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                <div className="text-primary font-semibold mb-4 uppercase text-sm tracking-wider">AI-native redesign</div>
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">AI as the operating model, not an add-on</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Entire steps, sometimes entire roles, eliminated</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary">✓</span>
                    <span className="text-muted-foreground">Structural change, not incremental speed</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-8 bg-muted border border-primary/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-primary mb-4">Three places workflow redesign pays off</h3>
              <div className="space-y-6">
                <div>
                  <div className="text-foreground font-semibold mb-2">Discovery and research synthesis</div>
                ...
                <div>
                  <div className="text-foreground font-semibold mb-2">Design-to-code handoff</div>
                  <p className="text-muted-foreground text-sm leading-relaxed">
                ...
                <div>
                  <div className="text-foreground font-semibold mb-2">Prototyping and validation</div>
                  <p className="text-muted-foreground text-sm leading-relaxed">
            ...
            <div className="my-8 bg-muted border border-primary/20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-primary mb-4">Better questions to be asking</h3>
