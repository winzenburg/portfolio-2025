        ...
        <div className="container mx-auto px-6 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none [&_p]:mb-6 [&_p:last-child]:mb-0 [&_blockquote]:my-8 [&_blockquote:last-child]:mb-0 [&_ul]:my-6 [&_ol]:my-6 [&_ul]:pl-6 [&_ol]:pl-6 [&_ul]:list-disc [&_ol]:list-decimal [&_li]:my-2 [&_li]:marker:text-primary [&_li]:text-foreground">
            ...
            <div className="my-10 bg-destructive/10 border border-destructive/30 rounded-lg p-8">
              <div className="text-destructive font-semibold mb-4 uppercase text-sm tracking-wider">Common Failure Modes</div>
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">1</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Motion without outcomes</div>
                    <div className="text-muted-foreground text-sm">Lots of activity, few finished deliverables. The calendar is full but nothing ships.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">2</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Metrics without learning</div>
                    <div className="text-muted-foreground text-sm">Charts go up or down, but nobody changes behavior based on what they show.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">3</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Issues without resolution</div>
                    <div className="text-muted-foreground text-sm">Problems get talked about, then reappear next week. Nothing actually gets solved.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">4</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Strategy without translation</div>
                    <div className="text-muted-foreground text-sm">Goals exist, but weekly work doesn't clearly push them forward.</div>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-destructive font-bold text-xl">5</span>
                  <div>
                    <div className="text-foreground font-semibold mb-1">Ad-hoc process</div>
                    <div className="text-muted-foreground text-sm">Every recurring task is reinvented from scratch. No compounding.</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              <div className="text-center mb-6">
                <div className="text-sm font-semibold text-primary uppercase tracking-wider mb-2">Weekly Time Investment</div>
                <div className="text-3xl font-bold text-foreground">60-90 Minutes Total</div>
              </div>
              <div className="grid md:grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-primary mb-1">15-30 min</div>
                  <div className="text-sm text-muted-foreground">Monday planning</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary mb-1">30-45 min</div>
                  <div className="text-sm text-muted-foreground">Issues meeting</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary mb-1">10-20 min</div>
                  <div className="text-sm text-muted-foreground">Friday review</div>
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-muted/30 border border-border rounded-lg p-6">
              <div className="text-foreground font-semibold mb-4">Weekly Scorecard Example</div>
              <div className="space-y-4 text-muted-foreground">
                <div>
                  <span className="text-primary font-semibold">Focus Metric:</span> Reduce time-to-first-value for new users
                </div>
                <div>
                  <span className="text-primary font-semibold">Outcomes:</span>
                ...
                <div>
                  <span className="text-primary font-semibold">Top Issue:</span> Users don't understand "what to do next" after they land
                </div>
                <div>
                  <span className="text-primary font-semibold">Results:</span> 2/3 outcomes completed. Onboarding completion improved from 18% → 31%
                </div>
                <div>
                  <span className="text-primary font-semibold">Learning:</span> The empty state copy mattered more than the feature checklist
                </div>
                <div>
                  <span className="text-primary font-semibold">Next Experiment:</span> Simplify the first screen to one primary action
                </div>
              </div>
            </div>
            ...
            <div className="my-10 bg-primary/5 border border-primary/20 rounded-lg p-8">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-muted-foreground">A BOS is a weekly loop that turns decisions into outcomes and outcomes into learning</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Keep five modules distinct: weekly, data, execution, issues, and process/people</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">Protect the system from bloat with hard limits (1 metric, 1-3 outcomes, 1-3 actions)</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">The compounding effect comes from Friday: learning + one improvement experiment</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-primary mt-1">→</span>
                  <span className="text-muted-foreground">You don't need a new tool. You need a repeatable weekly note and a willingness to decide</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-primary/8 border border-primary/20 rounded-lg p-8 my-12 text-center">
              ...
              <p className="text-muted-foreground mb-6">I've helped teams adopt this operating system across startups and enterprises. The key is adapting it to your specific context while keeping the core constraints intact.</p>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <Link href="/articles/weekly-rhythm" className="inline-flex items-center gap-2 text-primary hover:text-primary transition-colors text-lg font-semibold">
