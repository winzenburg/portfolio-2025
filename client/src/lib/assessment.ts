...
export const RECOMMENDATIONS: Record<DimensionId, EngagementRecommendation> = {
  ...
  capability: {
    ...
    why: "Your weakest dimension is capability and capacity. This is rarely fixed by a project, because the project ends and the gap returns. It is fixed by senior direction applied continuously, which is what an embedded retainer is for.",
    includes: [
      ...
      "Hiring support: role definition, portfolio review, interview design",
